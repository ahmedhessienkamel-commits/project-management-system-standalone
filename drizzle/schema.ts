...
export const projects = mysqlTable("projects", {
  ...
  estimatedTotalCost: decimal("estimatedTotalCost", { precision: 14, scale: 2 }).default("0").notNull(),
...
export const accountingDocuments = mysqlTable("accountingDocuments", {
  ...
  voucherCategory: mysqlEnum("voucherCategory", ["contractor", "supplier", "materials", "payroll", "operating", "administrative", "petty_cash", "asset"]),
