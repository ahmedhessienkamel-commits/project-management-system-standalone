...
export const projects = mysqlTable("projects", {
  ...
  boqItems: json("boqItems").$type<Array<{ kind: "main" | "sub"; code?: string; name: string; parentCode?: string; unit?: string; quantity?: number; unitRate?: number; plannedAmount: number; stageId?: number; costItemId?: number; notes?: string }>>(),
  plannedSalaryBudget: decimal("plannedSalaryBudget", { precision: 14, scale: 2 }).default("0").notNull(),
  plannedAdminExpenseBudget: decimal("plannedAdminExpenseBudget", { precision: 14, scale: 2 }).default("0").notNull(),
...
export const contractorContracts = mysqlTable("contractorContracts", {
  ...
  plannedBudgetItems: json("plannedBudgetItems").$type<Array<{ kind: "main" | "sub"; name: string; code?: string; parentCode?: string; costItemId?: number; stageId?: number; plannedAmount: number; notes?: string }>>(),
  plannedSalaryBudget: decimal("plannedSalaryBudget", { precision: 14, scale: 2 }).default("0").notNull(),
  plannedAdminExpenseBudget: decimal("plannedAdminExpenseBudget", { precision: 14, scale: 2 }).default("0").notNull(),
  preTaxAmount: decimal("preTaxAmount", { precision: 14, scale: 2 }).default("0").notNull(),
  taxRate: decimal("taxRate", { precision: 5, scale: 2 }).default("15").notNull(),
