...
- [ ] إضافة لوحة عبء العمل حسب الموظف مع توزيع الحالات والمهام المتأخرة
- [ ] إضافة مؤشرات الالتزام بمواعيد الموافقات ومتوسط زمن الاعتماد
- [ ] إضافة تنبيهات تلقائية للمهام المتأخرة داخل النظام وبالبريد
- [ ] إضافة ملخص يومي بالبريد للمدير العام عن المهام والموافقات المتأخرة
- [ ] إضافة سجل تدقيق زمني قابل للعرض لكل قرار وتحديث في واجهة المدير
