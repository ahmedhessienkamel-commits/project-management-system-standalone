...
- [x] إتاحة طلب مواد لمسؤول الموقع والمشتريات بدون بند تكلفة في النموذج، مع تعيين بند التكلفة إلزاميًا لدى المالك بعد اعتماد مصطفى وقبل اعتماد مدير المشاريع.

- [x] إتاحة قسم «طلب شراء مواد» ونموذج الطلب لمسؤول الموقع ومسؤول المشتريات فقط، دون تعديل الداشبورد أو السيولة أو الترحيلات.

- [x] إصلاح رابط «طلبات المواد» لمسؤول المشتريات بحيث يفتح نموذج الطلب في ‎/operations?tab=procurement‎ بدل صفحة المخزون.

- [x] إنشاء صفحة مستقلة فعليًا لطلب شراء المواد لمسؤول المشتريات وربط القائمة والزر بها بعد إصلاح التوجيه.
- [x] تدقيق وربط سند سداد المقاول المسجل بتقرير السيولة كمخرج نقدي فعلي دون ازدواج تكلفة المشروع.
- [x] حصر بيانات مشروع المهدية والقيود التابعة له وعرض نطاق الحذف للموافقة الصريحة قبل أي عملية حذف.
- [x] قصر ملخص تحميل المصروفات المشتركة على مشاريع الشركة النشطة لمنع ظهور مشروع المهدية من شركة أو بيانات قديمة أخرى.

- [x] إتاحة معاينة كاملة لطلبات المواد للمالك ولمصطفى حتى إن كان الاعتماد لدى مسؤول آخر، مع إبقاء زر القرار للمرحلة المخوّلة فقط.
- [x] استبدال مسمى «المالك» بمسمى «مدير الحسابات» في مسار اعتماد طلب المواد حيث تمثل الخطوة تعيين بند التكلفة.
- [x] حصر بيانات مشروع المهدية وسجلاتها المرتبطة للعرض فقط قبل أي قرار حذف.

- [x] حذف سجل مشروع «المهدية» الفارغ، الكود 002، بعد التأكيد الصريح والتحقق النهائي من خلوه من الارتباطات.

- [x] إضافة خيار «سلفة» إلى أنواع صرف سند العهدة.
- [x] إتاحة اختيار المستفيد كسجل موظف أو أجير وربط السلفة بحسابه.
- [x] ربط السلفة بمسير الرواتب مع خيار الخصم كاملًا من المسير القادم أو تقسيطها على عدة أشهر.

- [ ] فصل صاحب العهدة الممولة عن مستفيد السلفة في نموذج سند العهدة، ومنع نسخ اختيار المستفيد إلى بطاقة العهدة.

- [x] إصلاح كشف حساب المورد ليعرض سداد المستخلص الفعلي في خانة المدفوع والمتبقي، مع منع الازدواج بين المستخلص والفاتورة وسند الصرف والسيولة.

- [x] إصلاح كشف حساب المورد لاحتساب سندات الصرف المرحّلة وربطها بالمستخلصات والفواتير دون تكرار، مع اختبار مالي مباشر.

- [x] عرض مقدم الطلب والصفة والتواريخ وحالة الطلب بوضوح داخل بطاقات طلبات السلف والإجازات.
- [x] إتاحة بطاقات طلبات السلف والإجازات لمصطفى باعتباره مراجعًا في دورة الموافقة دون منحه صلاحيات اعتماد غير مخصصة.
- [x] فصل بطاقة العهدة الممولة عن مستفيد السلفة في نموذج حركة العهدة ومنع النسخ التلقائي بينهما.
- [x] إظهار جميع بنود التكلفة الإدارية المناسبة عند اختيار حركة عهدة مصنفة كمصروفات إدارية.
- [x] التحقق من كشف المورد بتدفق يربط المستخلص وفاتورة الشراء وسند الصرف دون تكرار في المدفوع أو المتبقي.

- [x] التحقق من رابط النسخة التي يستخدمها العميل ومزامنتها مع التعديلات المنشورة قبل اعتبار أي بند منجزًا.
- [x] التحقق من ظهور بطاقات السلف والإجازات والعهدة وكشف المورد في البيئة الفعلية بحساب العميل، لا في بيئة التطوير فقط.

- [x] التحقق من أن خدمة Railway تعمل على منطقة EU West المتاحة؛ لم يلزم تغيير يدوي إضافي.
- [x] مزامنة الإصلاحات الأخيرة مع فرع GitHub المرتبط بخدمة Railway والتحقق من نشرها بنجاح.

- [x] جعل سند الصرف يعرض كل الحسابات البنكية والخزائن المنشأة للشركة النشطة مع احترام الصلاحيات.
- [x] ربط المصروفات الإدارية المسجلة من العهدة بالتقارير والمؤشرات ولوحة التنفيذ دون إسقاطها أو عدّها مرتين.
- [x] اختبار اتساق الحسابات البنكية والمصروفات الإدارية عبر الواجهة والراوتر والتقارير على النسخة الحية.

- [x] إصلاح ظهور المصروفات الإدارية المحمّلة على المشروع في مؤشرات داشبورد المشروع، مع إبقاء المصروفات الإدارية العامة منفصلة.
- [x] ربط قيمة المصروف الإداري في مركز التكلفة وقائمة الدخل والسيولة والتقارير ذات الصلة دون احتساب مزدوج.
- [x] إضافة اختبار يثبت ظهور المصروف الإداري في داشبورد المشروع والتقارير بعد تسجيله من العهدة.

- [x] إضافة عملية تحويل داخلية بين حسابين بنكيين أو بين بنك وخزينة داخل الشركة، بالتاريخ والحسابين والمبلغ فقط، مع قيد محاسبي مزدوج تلقائيًا.
- [x] ترتيب كشف حساب المورد تصاعديًا من أقدم حركة إلى أحدث حركة وتصحيح الرصيد التراكمي بعد كل حركة.
- [x] إظهار كل حركات الموافقات المعتمدة والمرفوضة لمستخدم الإدارة ولمصطفى مع بيانات كاملة ومعاينة وحذف محمي.
- [x] تصحيح حالة المستخلص المدفوع في لوحة التنفيذ ومركز التكلفة عند وجود سداد فعلي مرتبط.
- [x] ربط نسبة إنجاز المرحلة ونسبة إنجاز المشروع بالمؤشرات الفعلية الظاهرة في لوحة التنفيذ.
- [x] توزيع نصيب المشروع من المصروفات الإدارية والنثرية من العهد وسندات الصرف داخل التقارير والداشبورد دون ازدواج.
- [x] إظهار المدفوع الفعلي لمرحلة الحفر في مركز التكلفة وربطه بالمستخلصات وسندات الصرف.

- [x] إصلاح ظهور جميع الحسابات البنكية والخزائن التابعة للشركة في نماذج سند الصرف والسداد.
- [x] عرض نسبة إنجاز المشروع والمرحلة بناءً على تقدم المرحلة والمستخلصات الفعلية.
...
- [x] التحقق الحي من كشف المورد وترتيب الحركات والرصيد التراكمي بعد النشر.

- [x] مزامنة الإصدار 1420c9ac مع مستودع GitHub/Railway الخارجي بعد منح حساب النشر صلاحية الكتابة على المستودع الصحيح.

- [x] فصل ميزانية المشروع الكلية قبل الضريبة عن ميزانيات المراحل، وتسجيل ميزانية نمار الكلية كـ 13,166,268 ر.س دون افتراض أن ميزانية المرحلة مساوية لها.
- [x] تحديث مؤشرات وتقارير الميزانية لتعرض حالة ميزانيات المراحل غير المحددة بوضوح دون تشويه إجمالي المشروع.
- [x] إضافة فلتر بحث متقدم لأرشيف الموافقات حسب النوع والحالة والمقدم والتاريخ والمشروع والنص المرجعي.
- [x] إظهار سبب الرفض داخل معاينة كل طلب موافقة مرفوض وفي بطاقته الأرشيفية.
- [x] إضافة اختبارات فصل ميزانية المشروع عن المرحلة وأرشيف الموافقات بعد التعديل.

- [ ] مراجعة جميع البنود المالية السابقة المفتوحة وإغلاقها أو توثيق سبب بقائها قبل بدء تنفيذ الطلبات الجديدة.

- [x] تصحيح انحراف مركز التكلفة بحيث لا يُعرض كتجاوز عندما تكون التكلفة الفعلية أقل من ميزانية المرحلة، مع تسمية المتبقي والتجاوز باتجاه صحيح.
- [x] توحيد تحميل المصروفات الإدارية والنثرية المباشرة والموزعة بين ملخص المشروع وقائمة الدخل وكل التقارير دون ازدواج أو اختفاء.

- [x] إظهار أرشيف طلبات الإجازات والسلف وفلتره ومسار الاعتماد لك ولمصطفى مع الحفاظ على صلاحية القرار للمسؤول الحالي فقط.
- [x] عرض المرحلة الحالية واسم المسؤول الذي يقف عنده كل طلب إجازة أو سلفة.

- [x] إضافة أرشيف متقدم لقسم الموافقات ولوحة توقيع المديرين مع فلاتر النوع والحالة والمقدم والتاريخ والمشروع والمرجع.
- [x] عرض المرحلة الحالية والمسؤول المنتظر عنده القرار في كل بطاقة موافقة، مع إتاحة العرض والمعاينة لك ولمصطفى.
- [x] إظهار سبب الرفض داخل معاينة مستندات لوحة توقيع المديرين عند رفضها.
