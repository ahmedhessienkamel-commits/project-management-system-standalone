...
- [ ] قصر صفحة الوحدات التشغيلية على دورة المشتريات فقط
- [ ] إخراج إضافة الموردين والمقاولين إلى قسم المقاولين والموردين
- [ ] إخراج المستخلصات إلى قسم المقاولون والمستخلصات
- [ ] إخراج العهد إلى قائمة العهد المستقلة
- [ ] إخراج الحضور والمرفقات من الوحدات التشغيلية نهائيًا
- [ ] إخراج مركز التكلفة وقائمة الدخل إلى تقارير مستقلة للمشروع
- [ ] إعادة تسمية القسم الخارجي إلى دورة المشتريات
- [ ] اختبار جميع الروابط وعدم فقدان الوظائف الحالية
...
- [ ] إضافة قسم معلومات الشركة في أعلى القائمة الجانبية
- [ ] إضافة السجل التجاري والرقم الضريبي والعنوان الوطني وبيانات التواصل والشعار
- [ ] استخدام معلومات الشركة في الفواتير وسندات القبض والصرف والمستندات
- [ ] إضافة قسم البنوك والنقدية أسفل معلومات الشركة
- [ ] إضافة حسابات بنكية متعددة مع البنك ورقم الحساب وIBAN والحساب المحاسبي
- [ ] إضافة خزائن وحسابات نقدية وربطها بشجرة الحسابات
- [ ] إظهار الحسابات البنكية والخزائن في خيارات سندات القبض والصرف
