...
- [ ] إضافة بطاقة رصيد نهائي تظهر بعد اختيار الموظف ونوع العهدة وقبل جدول كشف الحساب
- [ ] عرض إجمالي العهد المسجلة وإجمالي المصروف والرصيد المتبقي بالأرقام الإنجليزية
- [ ] تحديث البطاقة تلقائيًا عند تغيير الموظف أو نوع العهدة والتأكد من RTL والاختبارات
