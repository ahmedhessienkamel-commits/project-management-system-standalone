...
- [ ] تشخيص استمرار ظهور الملخص المالي العام في الرابط الذي يفتحه المستخدم رغم تعديلات Home.tsx المحفوظة.
- [ ] التحقق من أن الخدمة المنشورة تعرض build/commit الحالي وإبطال أي مسار أو cache يعيد الواجهة القديمة.

- [ ] مزامنة نسخة الداشبورد المصححة إلى مستودع GitHub المرتبط بـRailway والتحقق من Deployment الجديد.
...
- [ ] ربط المرشحات بتحديث البيانات واختبار العرض على سطح المكتب والموبايل ثم نشره على Railway.
