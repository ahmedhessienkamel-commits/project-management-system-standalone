...
- [ ] إعادة بناء رئيسية وادي نمار بنفس أقسام وألوان وتنسيق الصور المرجعية
- [ ] إعادة بناء رئيسية المهدية من نفس الهيكل مع فلترة بياناتها
- [ ] استعادة لوحة التحكم والبطاقات والعدادات وبيانات المشروع والاختصارات والملخص المالي
- [ ] إزالة الفهرس وقسم المراحل فقط، دون حذف باقي تفاصيل الصفحة الأصلية
- [ ] اختبار التطابق البصري والصيغ والروابط وتسليم النسخة
