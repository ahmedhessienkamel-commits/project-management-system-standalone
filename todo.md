...
## Party registers in document activity
- [x] إضافة قسم مستقل للعملاء داخل حركة المستندات
- [x] إضافة قسم مستقل للموردين داخل حركة المستندات
- [x] عرض البيانات القانونية والعنوانية والتواصلية للطرف في السجل
- [x] إتاحة تعديل العميل أو المورد من السجل حسب الصلاحية
- [x] إتاحة حذف أو تعطيل العميل أو المورد مع حماية المستندات والقيود المرتبطة

## Invoice save failure
- [x] إصلاح عدم إنشاء فاتورة المبيعات أو المشتريات عند الضغط على الحفظ
- [x] إظهار رسالة نجاح أو خطأ مفهومة من إجراء الحفظ
- [x] تحديث حركة المستندات وقوائم السداد بعد حفظ الفاتورة
- [x] اختبار الحفظ الفعلي وظهور الفاتورة في السجل

## Combined party register and invoice save fix
- [x] إكمال أزرار تعديل وحذف العملاء والموردين داخل حركة المستندات
- [x] إصلاح حفظ الفواتير وتحديث سجل الحركة فورًا بعد الحفظ

## Party register edit completion
- [x] إعادة استخدام نموذج الطرف لتعديل العملاء والموردين من سجل حركة المستندات
- [x] تحديث بيانات الطرف عبر إجراء خادمي مع سجل تدقيق وتحديث القائمة

## Supplier statements navigation
- [x] نقل «كشوف حسابات الموردين» تحت قائمة «العقود والمستخلصات» مباشرة

## Sales invoice debit-only save regression
- [x] إصلاح تعارض حفظ فاتورة المبيعات الذي يرفض وجود بند مدين رغم اعتماد الإيراد الدائن فقط

## Sales invoice revenue account selection
- [x] إزالة الرقم الضريبي من قسم قيد فاتورة المبيعات واستبداله بحساب الإيراد الدائن
- [x] ربط الحساب الدائن تلقائيًا بالمشروع مع إتاحة اختيار إيراد مشروع آخر
- [x] تطبيق تحسينات واجهة فاتورة المبيعات وسند القبض والتنبيهات المقترحة

## Invoice activity actions
- [x] إضافة زر عرض فاتورة المبيعات داخل بطاقة حركة المستندات
- [x] إضافة زر سند قبض مرتبط بفاتورة المبيعات داخل البطاقة وإتاحته للمالك ومصطفى

## Document action bundle and PDF
- [x] إكمال أزرار العرض والتعديل والتحصيل داخل بطاقة المستند
- [x] إضافة زر تحميل PDF لكل مستند مع قالب RTL احترافي
- [x] تطبيق الإجراءات المناسبة حسب نوع المستند وإتاحتها للمستخدمين المخولين

## Automatic invoice tax calculation
- [x] إضافة حقل المبلغ قبل الضريبة لفاتورة المبيعات
- [x] إضافة اختيار نسبة ضريبة 5% أو 15%
- [x] احتساب قيمة الضريبة والمبلغ شامل الضريبة تلقائيًا وتحديث الإجمالي
...
- [x] Define revenue treatment and project-level loading for project sales/collections without double counting.
...
## إسناد مهام الفريق للمدير العام — 2026-08-21
- [x] إضافة صلاحية مستقلة للمدير العام لإسناد المهام للفريق.
- [x] تمكين المدير العام من إنشاء مهمة وتحديد المسؤول والمشروع والأولوية والموعد النهائي دون فتح بقية عمليات النظام.
- [x] عرض قائمة مهام المدير العام مع حالات التنفيذ والتصفية حسب المشروع والمسؤول والحالة.
- [x] الحفاظ على منع المدير العام من إنشاء أو تعديل أو حذف المستندات والعمليات الأخرى، مع استمرار صلاحيات اعتماد المسيرات والمستخلصات.
- [x] إضافة اختبارات للصلاحية وتدفق إنشاء المهمة وتحديث الحالة.
- [x] فحص شاشة المهام بصريًا وحفظ لقطة النسخة المنشورة.

## صلاحيات المدير العام وطلبات الموظفين — 2026-08-21
- [ ] قصر واجهة المدير العام على لوحة التحكم والموافقات والتوقيعات ومركز التكلفة وقائمة الدخل والمبيعات والتحصيلات فقط.
- [ ] إضافة نموذج طلب إجازة لكل مستخدم مع نوع الإجازة والتواريخ والمدة والملاحظات.
- [ ] إضافة نموذج طلب سلفة لكل مستخدم مع المبلغ والسبب وحالة السداد عند الحاجة.
- [ ] ربط طلبات الإجازات والسلف بدورة موافقات المدير العام مع سجل تدقيق وسبب الرفض.
- [ ] الحفاظ على القراءة فقط في الأقسام المسموحة ومنع بقية العمليات للمدير العام.
- [ ] إضافة اختبارات للطلبات والموافقات وتقييد القائمة الجانبية.
- [ ] فحص الواجهات بصريًا وحفظ النسخة المنشورة.

## توسيع تقارير المدير العام — 2026-08-21
- [ ] إظهار العقود والمستخلصات للمدير العام كبيانات وتقارير شاملة للقراءة فقط.
- [ ] إظهار المبيعات والتحصيلات للمدير العام كبيانات وتقارير شاملة للقراءة فقط.
- [ ] منع الإنشاء والتعديل والحذف داخل العقود والمستخلصات والمبيعات والتحصيلات للمدير العام.
- [ ] تحديث قائمة المدير العام لتشمل الأقسام المطلوبة فقط مع الموافقات والتوقيعات ومركز التكلفة وقائمة الدخل.

## تقرير المخزون للمدير العام — 2026-08-21
- [x] إضافة مراقبة المخزون والكميات إلى الأقسام المسموحة للمدير العام كتقرير قراءة فقط.
- [x] إخفاء أزرار إضافة واستلام وصرف وتعديل وحذف المخزون عن المدير العام.
- [x] عرض أرصدة الأصناف وحركات الاستلام والصرف والكميات المتبقية والمشروع والمورد كتقرير شامل.
- [x] اختبار القراءة فقط والفحص البصري وحفظ النسخة المنشورة.

## تشخيص عدم وصول البريد — 2026-08-21
- [x] فحص إعدادات Gmail SMTP ومسار إرسال الرسائل وسجلات الفشل دون كشف الأسرار.
- [x] اختبار اتصال SMTP والمصادقة ثم اختبار إرسال إلى العنوان الذي حدده المستخدم.
- [x] إصلاح إعدادات المرسل أو مسار الدعوة إذا ثبت أن المشكلة من التطبيق.
- [x] توثيق نتيجة الإرسال وأي سبب رفض من مزود البريد.

## أولوية عاجلة: إغلاق مشكلة البريد أولًا — 2026-08-21
- [x] تحديد ما إذا كان إجراء الدعوة يرسل بريدًا فعليًا أم ينشئ رابطًا فقط.
- [x] إصلاح خدمة إرسال البريد وربطها بإجراء الدعوة مع تسجيل نتيجة التسليم دون كشف الأسرار.
- [x] تنفيذ اختبار مصادقة SMTP واختبار إرسال فعلي إلى عنوان يحدده المستخدم.
- [x] عدم بدء أي تطوير آخر قبل إغلاق هذه المهمة وتوثيق سبب المشكلة والنتيجة.

## استكمال واجهة المدير العام — 2026-08-21
- [x] تثبيت قائمة المدير العام النهائية على الداشبورد والموافقات والتوقيعات ومركز التكلفة وقائمة الدخل والمبيعات والتحصيلات والعقود والمستخلصات ومراقبة المخزون كتقارير.
- [x] إكمال طلباتي وموافقات الإجازات والسلف في الواجهة.
- [x] إخفاء أزرار الإدخال والتعديل والحذف في العقود والمستخلصات والمبيعات والمخزون عن المدير العام.
- [x] اختبار العزل والصلاحيات وفحص الواجهة وحفظ النسخة.

## إشعارات الموافقات — 2026-08-21
- [x] حصر أنواع طلبات الموافقة ومسؤول كل نوع: المستخلصات، مسيرات الرواتب، الإجازات، السلف، والموافقات التشغيلية الأخرى.
- [x] إرسال بريد إلكتروني تلقائي للمسؤول صاحب الصلاحية عند إنشاء طلب موافقة، مع رابط مباشر لشاشة الاعتماد.
- [x] إضافة إشعارات داخل النظام مع عدد الطلبات المعلقة وحالة القراءة.
- [x] منع إرسال الإشعار إلى مستخدم لا يملك صلاحية الموافقة، وتسجيل نتيجة البريد دون كشف الأسرار.
- [x] إضافة اختبارات للتوجيه والإشعار، ثم فحص الواجهة وحفظ النسخة المنشورة.

## إصلاح erp.notifications.list — 2026-08-21
- [x] ربط الواجهة بإجراء الإشعارات الموجود `erp.controls.notifications` مع إجراء تعليم الإشعار كمقروء.
- [x] حماية واجهة الشريط العلوي من فشل استعلام الإشعارات حتى لا تتعطل الصفحة الرئيسية.
- [x] اختبار API والصفحة الرئيسية والبناء ثم حفظ النسخة.

## إصلاح جلسة قبول الدعوة والصلاحيات — 2026-08-21
- [x] تشخيص لماذا يفتح رابط الدعوة داخل جلسة المستخدم الحالي بدل حساب البريد المدعو.
- [x] فرض تسجيل دخول مستقل عند قبول الدعوة والتحقق من مطابقة البريد المدعو قبل إنشاء/تفعيل الحساب.
- [x] منع التصفح غير الموثق وتطبيق صلاحيات المدير العام من الخادم، وليس الواجهة فقط.
- [x] اختبار الرابط المباشر، الجلسة الجديدة، وقائمة الأقسام المسموحة ثم حفظ النسخة.

## تسجيل دخول المستخدمين المدعوين — 2026-08-21
- [x] إضافة تخزين آمن لكلمة مرور المستخدم أو إعداد تفعيل الحساب دون تخزين كلمة المرور نصًا صريحًا.
- [x] إضافة شاشة ومسار تسجيل الدخول بالبريد الإلكتروني وكلمة المرور.
- [x] ربط رابط الدعوة بالتفعيل الأولي فقط، ثم فرض تسجيل الدخول في كل زيارة لاحقة.
- [x] منع استخدام جلسة مستخدم آخر لقبول الدعوة أو تصفح النظام، واختبار عزل الصلاحيات.

## كلمة مرور مالك النظام — 2026-08-21
- [x] إضافة إجراء محمي لإنشاء أو تغيير كلمة مرور المستخدم الحالي دون تغيير دوره أو طريقة دخوله عبر Google.
- [x] إضافة واجهة إعداد كلمة المرور في إعدادات الحساب أو الملف الشخصي.
- [x] اختبار الدخول بالبريد وكلمة المرور وبقاء صلاحيات admin ثم حفظ النسخة.

## استعادة كلمة المرور وتحسين الدخول — 2026-08-21
- [x] إضافة طلب استعادة كلمة المرور برمز أحادي الاستخدام ومدة انتهاء قصيرة.
- [x] إرسال رسالة الاستعادة عبر Gmail دون كشف وجود البريد في النظام.
- [x] إضافة شاشة تعيين كلمة مرور جديدة والتحقق من الرمز.
- [x] تحسين واجهة تسجيل الدخول ورسائل البريد أو كلمة المرور الخاطئة.
- [x] إضافة اختبارات الاستعادة والبناء والفحص البصري ثم حفظ النسخة.

## إصلاح عداد الإشعارات الوهمي — 2026-08-21
- [x] تحديد سبب ظهور عداد 13 رغم عدم وجود طلبات موافقة حقيقية.
- [x] ربط عداد الشريط بالإشعارات غير المقروءة المرتبطة بطلب قائم فقط.
- [x] استبعاد الإشعارات التجريبية أو اليتيمة من العداد دون حذف سجل التدقيق.
- [x] اختبار العداد قبل وبعد إنشاء طلب موافقة فعلي ثم حفظ النسخة.

## تقييد مشاريع المدير العام — 2026-08-21
- [x] إخفاء زر إضافة مشروع ونماذج إنشاء وتعديل المشروع عن المدير العام.
- [x] منع إنشاء أو تعديل أو حذف المشاريع للمدير العام من الخادم حتى مع الوصول المباشر للرابط أو API.
- [x] إضافة شارة وضع المدير العام في صفحة المشاريع مع اختبار الصلاحيات وحفظ النسخة.

## موظف موقع وطلبات شراء المواد — 2026-08-21
- [ ] إضافة دور موظف موقع بصلاحية محدودة لطلبات شراء المواد فقط.
- [ ] إبقاء صفحة طلباتي العامة لموظف الموقع لتقديم طلبات الإجازة والسلف.
- [ ] إخفاء بقية الأقسام والعمليات والمستندات عن موظف الموقع.
- [ ] إرسال طلب المواد إلى مصطفى أولًا ثم مدير المشاريع بعد اعتماد مصطفى.
- [ ] إضافة بريد وإشعار داخل النظام عند وصول الطلب لكل مسؤول، مع اختبار الصلاحيات والحفظ.

## توسيع موظف الموقع في مراقبة المخزون — 2026-08-21
- [ ] إضافة دور site_worker إلى دعوات وتحديث أدوار المستخدمين.
- [ ] إظهار طلب شراء المواد واستلام الخامات وصرف الخامات فقط لموظف الموقع.
- [ ] إبقاء طلباتي للإجازات والسلف وإخفاء باقي الأقسام والعمليات.
- [ ] ربط عمليات المخزون بالمشروع المسند ومنع الاعتماد الذاتي.
- [ ] اختبار الوصول وسير الموافقات والبناء ثم حفظ النسخة.

- [x] إكمال دور موظف الموقع: عزل المشاريع المسندة وقصر الواجهة على طلبات المواد والاستلام والصرف وطلبات الإجازة والسلف
- [x] تقييد الخادم لموظف الموقع: منع إنشاء بطاقات الخامات والخدمات والتعديلات، والسماح بحركتي receipt/issue فقط
- [x] إكمال مسار اعتماد حركة المواد: موظف الموقع ثم مصطفى ثم مدير المشروع/المالك بحسب سياسة المشروع
- [x] إضافة اختبار وحدة لصلاحيات موظف الموقع والتحقق البصري من الواجهة العربية RTL

- [x] قصر موظف الموقع في بطاقة الاستلام والصرف على الخامة والكمية والبيانات التشغيلية دون بند تكلفة أو تحميل محاسبي
- [x] تعديل اعتماد حركة المواد لموظف الموقع إلى مصطفى ثم المالك، مع جعل تحديد بند التكلفة والتحميل بعد اعتماد المالك
- [x] منع موظف الموقع من تقارير المشروع والداشبورد والاكتفاء بتقرير الخامات المستلمة والمنصرفة
- [ ] اختبار أن حركة موظف الموقع لا تظهر في تقارير المشروع أو مؤشرات الداشبورد قبل اعتماد المالك

- [x] تثبيت قائمة موظف الموقع على ثلاثة مداخل فقط: طلب شراء مواد، بطاقة استلام خامات، بطاقة صرف خامات
- [x] جعل طلب شراء المواد لموظف الموقع مطابقًا لنموذج طلب المواد التشغيلي، دون إنشاء أمر شراء أو فاتورة أو بند تكلفة
- [x] إظهار بطاقتي الاستلام والصرف لموظف الموقع بالخامة والكمية والبيانات التشغيلية فقط
- [x] إبقاء الاعتماد والتحميل المحاسبي وبند التكلفة والتقارير خارج حساب موظف الموقع

- [x] إرسال إشعار داخلي وبريد لمصطفى عند إنشاء طلب مواد أو حركة استلام/صرف تحتاج اعتماده
- [x] إنشاء مرحلة اعتماد المالك وإشعاره بعد اعتماد مصطفى
- [x] إرسال إشعار نجاح/ترحيل بعد اعتماد المالك وتحديث السجلات المرتبطة
- [x] التحقق من أن الاستلام والصرف المرحلين يظهران تلقائيًا في الحسابات والتقارير المسموح بها فقط

- [x] تحويل طلب المواد المحفوظ إلى مستند احترافي بمعاينة وتعديل وحذف وتنزيل PDF للمالك
- [x] إضافة صلاحيات مصطفى لمعاينة وتعديل وتنزيل طلب المواد دون الحذف
- [x] ربط أزرار المستند بإجراءات آمنة تحفظ مسار الاعتماد وسجل التدقيق

- [x] إصلاح رابط الدعوة المرسل ليستخدم صفحة تفعيل البريد وكلمة المرور مباشرة بدل Manus OAuth
- [x] الحفاظ على OAuth كخيار دخول مستقل وعدم استخدامه كرابط دعوة افتراضي
- [x] اختبار رابط دعوة جديد والتأكد من عدم ظهور صفحة Manus للمستخدم المدعو

- [x] فحص سبب استمرار إرسال رابط دعوة Manus OAuth رغم وجود مسار التفعيل المباشر
- [x] اختبار رابط دعوة جديد من البريد وبطاقة الدعوة والتأكد من أنه يبدأ بـ /accept-invitation

- [x] منع أي رابط دعوة قديم أو غير مباشر من فتح Manus OAuth
- [x] توفير واختبار رابط تفعيل مستقل للمستخدم المدعو لا يعتمد على Manus

- [ ] تحديد الرابط الفعلي الذي يصل للمستخدم قبل التحويل إلى OAuth
- [ ] فصل صفحة الدعوة على مستوى التطبيق عن أي استدعاء تلقائي لـ Manus OAuth
- [ ] إضافة تحقق واضح للرابط المباشر قبل إرسال الدعوة

- [x] إضافة خانة بريد الدعوة تلقائيًا للقراءة فقط في شاشة التفعيل
- [x] إضافة زر عين لإظهار وإخفاء كلمة المرور الجديدة
- [x] الحفاظ على خانة تأكيد كلمة المرور والتحقق من التطابق
- [x] إضافة اختبار واجهة/منطق لمسار التفعيل الجديد

- [x] عرض رابط الدخول المباشر مع زر نسخ بعد نجاح تفعيل الدعوة
- [x] إبقاء شاشة الدخول مقتصرة على البريد الإلكتروني وكلمة المرور
- [x] إظهار رابط نسيت كلمة المرور أسفل نموذج الدخول وربطه بالاستعادة الحالية
- [x] إضافة اختبار لتجربة النجاح بعد التفعيل ورابط الدخول

- [x] منع التحويل بعد تفعيل الدعوة إلى شاشة Manus Login
- [x] توجيه المستخدم بعد التفعيل إلى /login الداخلي بالبريد وكلمة المرور
- [x] اختبار أن جلسة كلمة المرور لا تستدعي OAuth بعد نجاح التفعيل

- [x] إصلاح عدم ظهور بريد الدعوة تلقائيًا في شاشة التفعيل
- [x] السماح بكتابة البريد يدويًا عند تعذر جلبه مع بقاء الرمز هو المرجع الأمني
- [x] اختبار حالة البريد المحمل وحالة الإدخال اليدوي

- [x] إصلاح فقدان جلسة البريد وكلمة المرور بعد تسجيل الدخول
- [x] منع DashboardLayout من عرض شاشة تسجيل الدخول عند وجود جلسة داخلية صالحة
- [x] اختبار بقاء الجلسة عند الانتقال من /login إلى الداشبورد

- [ ] تتبع استجابة تسجيل الدخول الداخلي وطلب auth.me بعد الانتقال للداشبورد
- [ ] إصلاح فقدان كوكي جلسة المستخدم بين /login والصفحات المحمية
- [ ] إضافة اختبار يثبت استمرار الجلسة بعد تسجيل الدخول والتفعيل

- [x] حفظ sessionToken العائد من تسجيل الدخول والتفعيل في sessionStorage
- [x] إرسال sessionToken مع طلبات auth.me وباقي طلبات النظام
- [x] اختبار عدم ظهور شاشة تسجيل الدخول بعد نجاح الدخول الداخلي

- [x] إزالة زر «إنشاء مشروع» من واجهة المدير العام ومنع ظهوره في الشريط العلوي
- [x] ترتيب قائمة المدير العام: الداشبورد ثم الموافقات والاعتمادات ثم العقود والمقاولات كتقارير ثم المبيعات والتحصيلات ثم مراقبة المخزون والكميات ثم قائمة دخل المشاريع
- [x] تطوير صفحة الموافقات ببحث حسب الموظف والتاريخ والمستند مع عداد الإشعارات على اسم القائمة
- [x] جعل العقود والمستخلصات للمدير العام عرضًا تقريريًا فقط دون نماذج إدخال
- [x] تطوير عرض المدير العام للمبيعات والتحصيلات والمخزون والتنبيهات التشغيلية
- [x] حذف مركز التكلفة من قائمة المدير العام وإعادة تسمية قائمة الدخل إلى قائمة دخل المشاريع

- [x] إضافة نوع اعتماد لسند صرف فاتورة شراء المورد وربطه بالفاتورة والمورد وسند الاستلام إن وجد
- [x] إنشاء طلب اعتماد تلقائي عند تسجيل سند صرف فاتورة شراء، مع إشعار المدير العام
- [x] عرض سندات صرف فواتير الشراء في صفحة الموافقات والاعتمادات مع اعتماد المدير العام فقط
- [x] منع الترحيل النهائي أو اعتبار السند معتمدًا قبل موافقة المدير العام وإضافة اختبارات للمسار
- [x] إصلاح عداد الإشعارات ليشمل إشعارات purchase_payment_pending ويعرض غير المقروء الحقيقي للمستخدم
- [x] التحقق النهائي من عزل موظف الموقع في طلب المواد والاستلام والصرف مع منع الحركات الأخرى واختبارات الصلاحيات
- [x] منع المدير العام من إنشاء أو تعديل فواتير المبيعات وسندات القبض، وتحويل المبيعات إلى تقارير للعرض فقط
- [x] تطوير فلاتر الموافقات بطلب/تصنيف وموظف وفترة تاريخ من وإلى
- [x] إضافة صفحة إسناد مهام لفريق العمل مع حالات وتتبع وتواريخ وأولوية
- [x] إرسال إشعار داخلي وبريد إلكتروني عند إسناد المهمة وتحديث حالتها
- [x] إضافة اختبارات لوحدة مهام الفريق وصلاحيات المدير العام
- [x] تقييد رؤية وتحديث مهام الفريق بحسب المدير أو الموظف المسؤول
- [x] إضافة لوحة عبء العمل حسب الموظف مع توزيع الحالات والمهام المتأخرة
- [x] إضافة مؤشرات الالتزام بمواعيد الموافقات ومتوسط زمن الاعتماد
- [x] إضافة تنبيهات تلقائية للمهام المتأخرة داخل النظام وبالبريد
- [x] إضافة ملخص يومي بالبريد للمدير العام عن المهام والموافقات المتأخرة
- [x] إضافة سجل تدقيق زمني قابل للعرض لكل قرار وتحديث في واجهة المدير
- [ ] دعم اختيار عدد الموظفين المطلوبين للمهمة ثم اختيار الموظفين بعدد مطابق
- [ ] إضافة تاريخ بداية ونهاية ونسبة إنجاز للمهمة
- [ ] إعادة تصميم تتبع المهمة كمراحل مرئية تشمل التخطيط والتنفيذ والتوقف والمراجعة والإكمال
- [ ] إضافة اختبارات تعدد المسؤولين والتواريخ ومراحل التتبع
- [x] إضافة زر إرسال تذكير بالبريد من بطاقة المهمة لجميع المسؤولين المسندين باسم صاحب العمل
- [x] حماية إجراء تذكير المهمة للمالك والمدير العام مع اختبار نجاح وفشل الإرسال
- [x] تشخيص وإصلاح عدم حفظ المهمة الجديدة مع إظهار سبب الخطأ للمستخدم
- [x] إضافة اختبارات لمسار حفظ المهمة متعدد الموظفين والتواريخ
- [x] إضافة لوحة بحث سلسة للعقود والمستخلصات بحسب المرحلة والطرف والعقد
- [x] ربط نتائج البحث بالمقاولين والموردين والعقود والمستخلصات دون تعقيد الاستخدام
- [x] إعادة تسمية واجهة المدير من مراقبة المخزون والكميات إلى تقرير الخامات والكميات
- [x] تطوير صفحة مبيعات المدير إلى لوحة مؤشرات وتحليلات للعرض فقط
- [x] إزالة قسم عبء العمل حسب الموظف من صفحة المهام
- [x] إضافة اختبارات لصلاحيات العرض وعدم ظهور إجراءات الإنشاء في واجهة المدير
- [x] جعل بطاقة المهمة تعرض نسبة الإنجاز كمؤشر رئيسي بمنطق مشابه لمراحل المشروع
- [x] ربط الانتقال بين مراحل المهمة بتحديث نسبة الإنجاز بصريًا
- [x] تكبير وإبراز زر إرسال تذكير بالبريد داخل بطاقة المهمة
- [x] إظهار حالة كل مصروف في قائمة الدخل كمستحق غير مصروف أو مصروف جزئي أو مصروف بالكامل
- [x] عرض قيم تم صرفه والمتبقي المستحق لكل مصروف عند وجود صرف جزئي
- [x] توضيح إجماليات المصروفات المستحقة والمصروفة في قائمة الدخل
- [x] إظهار هوية واضحة لواجهة المدير العام في أول لوحة التحكم مع توضيح اختلافها عن المحاسب ومدير المشاريع
- [x] إضافة نوع طلب مسيرات الرواتب في فلاتر الموافقات مع اختيار الشهر وعرض النتائج المطابقة
- [x] إضافة نوع طلب المستخلصات مع اختيار المرحلة ثم المقاول وتصفية النتائج المطابقة
- [ ] إصلاح حفظ سند الصرف من حساب المالك وظهوره في سجل المستندات
- [x] إظهار تنبيه واضح يحدد الحقول المطلوبة إذا كان زر حفظ سند الصرف معطلًا
- [x] اختبار صلاحيات المالك والمعاينة والتعديل والحذف والتنزيل لسند الصرف
- [x] تشخيص خطأ الحفظ الفعلي لسند الصرف بعد اكتمال الحقول وإظهار سبب الفشل
- [x] إصلاح إنشاء سند الصرف وتحديث سجل المستندات بعد نجاح الحفظ
- [x] إضافة بحث وتصفية احترافية لأرشيف سندات الصرف حسب النوع والتصنيف والمستفيد والتاريخ والحالة
- [x] إصلاح تحديث أرشيف سندات الصرف وظهور السند الجديد فور الحفظ
- [x] اختبار نتائج البحث وإجراءات المعاينة والتعديل والحذف والتنزيل في الأرشيف
- [x] تشخيص اختلاف الشركة النشطة أو ترشيح الأرشيف الذي يمنع ظهور سند المالك الجديد
- [x] إصلاح ظهور سند الصرف الجديد في أرشيف المالك مع اختبار تبديل الشركة
- [x] مراجعة صلاحيات مصطفى الفعلية بعد التعديلات الأخيرة
- [x] اختبار ظهور وظائف مصطفى وقيود الإنشاء والتعديل والاعتماد من الواجهة والخادم
- [ ] تعميم لوحة البحث الاحترافية على أرشيفات المبيعات والتحصيلات وباقي سجلات المستندات
- [x] إعادة ضبط صلاحيات مصطفى ليملك الإنشاء والتعديل والاعتماد ويُمنع من الحذف فقط
- [x] ضبط سلسلة اعتماد طلبات المواد والمستخلصات ومسيرات الرواتب حسب الأدوار المتفق عليها

- [x] تحديث سلسلة اعتماد مسير الرواتب: مصطفى ينشئ، المالك يعتمد، المدير العام يعتمد نهائيًا.
- [x] جعل رفض مسير الرواتب يعيد المستند للموظف السابق للتعديل وإعادة الإرسال، مع السماح للمالك بحذفه وإنشاء مسير جديد.
- [x] تحديث سلسلة اعتماد مستخلص المقاول: مصطفى يسجل، المالك يعتمد، مدير المشاريع يعتمد، المدير العام يعتمد نهائيًا.
- [x] تحديث سلسلة اعتماد طلب شراء المواد: موظف الموقع يسجل، مصطفى يعتمد، مدير المشاريع يعتمد، المدير العام يعتمد نهائيًا.
- [x] مزامنة واجهة الموافقات مع صاحب المرحلة الحالية وإخفاء أزرار الاعتماد غير المصرح بها.
- [x] إضافة اختبارات انتقال المراحل والرفض وإعادة الإرسال ومنع الحذف لغير المالك.

- [x] تشخيص وإصلاح خطأ 502 عند تحميل صفحة الموافقات، والتحقق من طلبات tRPC المرتبطة بها.

- [x] إضافة مركز القرار التنفيذي للموافقات والالتزامات ذات الأولوية.
- [x] إضافة مؤشرات التدفق النقدي والالتزامات القادمة لواجهة المدير العام.
- [x] إضافة لوحة المخاطر والتنبيهات التنفيذية المبنية على البيانات الفعلية.
- [x] تحسين مقارنة المشاريع لتوضيح الميزانية والمنفذ والانحراف ونسبة الإنجاز.
- [x] اختبار واجهة المدير الجديدة وحفظ النسخة المنشورة.

- [x] إضافة زر رسالة أو تنبيه سريع لمدير المشروع من بطاقة تنبيه المشروع.
- [x] ربط التنبيه بالبريد والإشعارات مع تسجيل العملية في سجل التدقيق.
- [x] اختبار مسار الإرسال وحفظ النسخة المنشورة.

- [x] جعل المرجع المرتبط اختياريًا في فاتورة البيع والسماح بالحفظ بدونه.
- [x] اختبار حفظ فاتورة بيع دون مرجع مرتبط والتحقق من بقاء الربط الاختياري متاحًا.

- [x] إزالة إلزام النوع والمرجع معًا من قسم المستند المرتبط وإضافة خيار بدون مستند مرتبط.
- [x] التحقق من حفظ الفاتورة دون اختيار النوع أو المرجع.

- [x] تشخيص وإصلاح عدم استجابة زر حفظ فاتورة المبيعات عند عدم وجود مستند مرتبط.
- [x] اختبار إرسال وحفظ فاتورة بيع بدون مستند مرتبط والتحقق من ظهورها في السجل.

- [x] تشخيص استمرار إجمالي مبيعات 112.7 ريال بعد حذف الفواتير التجريبية.
- [x] إصلاح احتساب أو حذف حركة البيع اليتيمة وتحديث إجماليات صفحة المبيعات.
- [x] التحقق من عدم تأثر المبيعات الحقيقية وحفظ النسخة المصححة.

- [x] إضافة حذف مترابط للفواتير يزيل الحركات التابعة تلقائيًا دون حذف المستندات المستقلة.
- [x] الحفاظ على سجل التدقيق وتحديث الوحدة وحركات التحصيل والاعتماد عند حذف فاتورة بيع.
- [x] اختبار الحذف المترابط للفواتير والمبيعات والتحصيلات وحفظ النسخة المنشورة.

- [x] إعادة ترتيب طلباتي والموافقات والمستندات تحت قسم التقارير في القائمة الجانبية.
- [x] إصلاح عداد الإشعارات ليعرض التنبيهات الحقيقية المعلقة فقط.
- [x] تنظيف الإشعارات الوهمية أو القديمة والتحقق من عدم حذف تنبيهات حقيقية.
- [x] اختبار الترتيب والعداد وحفظ النسخة المنشورة.

- [x] نقل الموافقات والمستندات وطلباتي مباشرة أسفل كشوف حسابات العهد في القائمة الجانبية فقط.
- [x] التحقق من ترتيب القائمة وحفظ النسخة المنشورة دون تغيير الصلاحيات أو المسارات.

- [x] تشخيص وإصلاح خطأ 500 عند تحميل صفحة تقرير الخامات والكميات.
- [x] التحقق من طلبات الصفحة والبيانات المرتبطة بها ثم اختبار الإصلاح.

- [x] إضافة صفحة فرعية «موافقات بانتظار تعميد مسؤولين آخرين» تحت الموافقات.
- [x] عرض المسؤول الحالي ونوع المستند والمشروع ومدة الانتظار من بيانات الموافقات الفعلية.
- [x] إضافة زر تذكير بالبريد لكل مستند مع إشعار وسجل تدقيق وحماية الصلاحيات.
- [x] اختبار الصفحة والتذكير وحفظ النسخة المنشورة.

- [x] إصلاح عدم ظهور عقد المقاول في نموذج تقرير الخامات والكميات عند اختيار المشروع والمورد.
- [x] التحقق من فلترة نوع العقد وربطه بالمشروع والمورد ثم اختبار الإصلاح.

- [x] تحسين بطاقة الموافقة المنتظرة لتوضح المستند ورقمه وقيمته ووصفه.
- [x] عرض منشئ المستند والمسؤول الحالي وسلسلة الاعتماد وتاريخ الإرسال ومدة الانتظار.
- [x] تمييز السجلات التجريبية أو غير الواضحة عن المستندات الفعلية دون اختلاق بيانات.
- [x] اختبار البطاقة المحسنة وحفظ النسخة المنشورة.

- [x] إعداد مصفوفة تحقق لصلاحيات مصطفى ومسارات الموافقة المتفق عليها.
- [x] مراجعة حواجز الخادم والبيانات الفعلية للإنشاء والتعديل والاعتماد ومنع الحذف.
- [x] فحص واجهة مصطفى ومسارات المواد والمستخلصات والرواتب والمستندات.
- [x] إصلاح أي فجوات وإضافة اختبارات صلاحيات واضحة.
- [x] توثيق نتيجة المراجعة وحفظ النسخة المنشورة.

- [x] إنشاء حسابات اختبار للمدير العام ومدير المشاريع وموظف الموقع وربطها بالشركة والمشروع دون التأثير على المستخدمين الفعليين.
- [x] إعداد بيانات اختبار معزولة لدورات طلب المواد والرواتب والمستخلصات تتضمن وسمًا واضحًا قابلًا للتتبع والتنظيف.
- [x] تنفيذ والتحقق من انتقال طلب المواد: موظف الموقع ثم مصطفى ثم المالك ثم مدير المشاريع ثم المدير العام.
- [x] تنفيذ والتحقق من دورتي الرواتب والمستخلصات وفق صلاحيات مصطفى والمالك والمدير العام ومدير المشاريع.
- [x] إصلاح معاينة وتصدير العقد لعرض بيانات المنشأة والمشروع وبنود العقد والقيم الحقيقية.
- [x] إصلاح معاينة وتصدير المستخلص لعرض بيانات المنشأة والمشروع والقيم والتفاصيل الفعلية.
- [x] إضافة اختبارات آلية لمسارات الاعتماد وبيانات قوالب العقود والمستخلصات.
- [x] توثيق النتائج وحفظ النسخة المنشورة بعد نجاح التحقق.

- [x] تشخيص وإعادة إنتاج سبب عرض قيمة صفرية في معاينة المستخلص رغم وجود قيمة فعلية في سجل المستخلص.
- [x] إضافة شريط بحث وفلترة احترافي أعلى سجل العقود يشمل المشروع والمرحلة والطرف ورقم العقد والحالة والفترة والقيمة.
- [x] إضافة شريط بحث وفلترة احترافي أعلى سجل المستخلصات يشمل المشروع والمرحلة والطرف والعقد ورقم المستخلص والحالة والفترة والقيمة.
- [x] إعداد سيناريوهات اختبار معزولة لتغطية المستندات والفواتير والسندات المتاحة في النظام.
- [x] تشغيل الاختبارات التشغيلية وتسجيل أي فشل في الإنشاء أو الاعتماد أو الربط أو المعاينة.
- [x] إصلاح الأخطاء المكتشفة وإضافة اختبارات تمنع تكرارها.
- [x] التحقق البصري وحفظ النسخة المنشورة بعد اكتمال المراجعة.

- [x] مراجعة مسير الرواتب الحالي وتحديد موضع إضافة راتب أجير يدوي ضمن الدورة المعتمدة.
- [x] إعادة إضافة نموذج راتب يدوي يميّز الأجير/العامل غير المسجل من الموظف المسجل.
- [x] اختبار إنشاء الراتب اليدوي وتمريره إلى سلسلة اعتماد الرواتب.
- [x] حصر وحذف مشروع [QA-APPROVAL-20260822] وبياناته الاختبارية المرتبطة فقط دون المساس بالسجلات التشغيلية.
- [x] التحقق النهائي وحفظ النسخة المنشورة.

- [x] تقسيم صفحة الموافقات بوضوح إلى «قراراتي المطلوبة» و«بانتظار مسؤولين آخرين» مع تنظيف السجلات التجريبية الباقية.
- [x] تحويل مسير الرواتب إلى حالة محفوظة قابلة للتعديل ثم إجراء منفصل لإرسال المسير كاملًا للاعتماد.
- [x] تمكين المالك من اعتماد المسير فقط وتمكين المدير العام من الاعتماد والتوقيع النهائي فقط.
- [x] إثبات مسير الرواتب المعتمد تلقائيًا كرواتب مستحقة لكل موظف دون تكرار القيود.
- [x] إضافة خيار «تسديد راتب مستحق من مسير» في سند الصرف مع اختيار الشهر والمسير وموظف أو جميع الموظفين.
- [x] اختبار دورة مسير الرواتب والحفظ والإرسال والاعتماد والتسديد والصلاحيات والتحقق البصري.
- [x] توثيق التغييرات وحفظ النسخة المنشورة.

- [x] تشخيص وإصلاح حساب ضريبة فاتورة المبيعات ليقتصر على النسب المعتمدة ويُظهر الإجمالي شامل الضريبة بصورة صحيحة.
- [x] إزالة دورة مشتريات المواد المكررة من صفحة التكاليف والمصروفات مع إبقائها في صفحة طلبات المواد المتخصصة.
- [x] توضيح سجل ووثائق الموردين وقيم أرصدتهم وربط المعاينة بالبيانات الفعلية بدل الأصفار الافتراضية.
- [x] استكمال معاينة المستخلص ببيانات المقاول والمشروع وبنود الأعمال المنجزة والقيم الفعلية.
- [x] إضافة العنوان الوطني إلى ملفات الموردين والمقاولين ونماذج المعاينة.
- [x] إضافة نموذج مباشرة عمل للموظف بتوقيع الموظف والمدير العام ومعاينة وتصدير.
- [x] إنشاء أرشيف مستندي للموظف يضم الإجازات والسلف ومباشرة العمل مع بحث وتصفية ومعاينة وتعديل وتنزيل.
- [x] قصر حذف مستندات الموظفين على المالك مع اختبار الصلاحيات والمعاينات والتصدير.
- [x] توثيق النتائج وحفظ النسخة المنشورة.

- [x] تشخيص سبب إظهار مستندات العهدة وغيرها أرقامًا صفرية أو بيانات متبدلة في المعاينة.
- [x] فصل القوالب المالية عن الملفات المرجعية ومنع عرض ملخص مالي عندما لا تتوفر قيم صحيحة.
- [x] تصحيح معاينة العهدة لتعرض صاحب العهدة والمشروع ونوع الحركة والقيم المتراكمة الفعلية دون خلط الحقول.
- [x] حصر وحذف طلبات الإجازة والسلف والموافقات الموسومة كسجلات اختبار فقط مع التحقق من عدم مساسها بالسجلات التشغيلية.
- [x] توسيع أرشيفات المستندات بأدوات البحث والمعاينة والتنزيل والتعديل والحذف المقصور على المالك حيثما تتوفر الدورة.
- [x] إضافة اختبارات تمنع الأصفار والحقول المتبدلة والتحقق بصريًا من القوالب والأرشيفات.
- [x] توثيق النتائج وحفظ النسخة المنشورة.

- [x] إضافة زر حذف ظاهر للمالك في سجل الموردين والمقاولين، مع تأكيد وحماية خلفية تمنع حذف غير المالك.
- [x] مراجعة بقية الأرشيفات النشطة التي تملك إجراءات تعديل وتصدير وإضافة حذف المالك حيث يوجد إجراء حذف آمن.
- [x] حصر واجهة مسؤول المشتريات في تقرير الخامات والكميات، طلب مواد، استلام مواد، صرف مواد، وطلباتي فقط.
- [x] منع مسؤول المشتريات من لوحة المشروع والتكاليف والمصروفات والموافقات وبقية المسارات غير التشغيلية من الواجهة والخلفية.
- [x] ضبط صفحة البداية لمسؤول المشتريات إلى تقرير الخامات والكميات بدلًا من لوحة المشروع.
- [x] إضافة اختبارات لصلاحيات مسؤول المشتريات وحذف الموردين للمالك فقط.

- [x] إعداد حزمة مصدر قابلة للنقل خارج المنصة دون أسرار أو بيانات تشغيلية.
- [x] إضافة دليل إعداد خارجي لقاعدة البيانات والبيئة وتسجيل الدخول البديل.
- [x] مراجعة الحزمة النهائية وتسليمها للتنزيل.

- [x] إعداد خطة قاعدة بيانات مستقلة ونقل آمن للبيانات التشغيلية.
- [x] مقارنة منصات الاستضافة الخارجية الملائمة لخادم Node.js وقاعدة MySQL.
- [x] تصميم وتحضير بديل تسجيل دخول محلي آمن عن المصادقة المدمجة.

- [x] تدقيق وتوثيق كل اعتماد على خدمات Manus وخدمات خارجية في الكود.
- [x] فصل مسار المصادقة والواجهة عن OAuth وSDK المدمجين وتشغيل Local Authentication فقط.
- [x] إعداد ملفات إنتاج مستقلة تشمل Dockerfile وCompose وقوالب البيئة وتعليمات التشغيل.
- [ ] إعداد قاعدة MySQL تجريبية محلية وتصدير بيانات اختبار آمنة مع تعليمات Backup وRestore.
- [x] اختبار بناء وتشغيل مستقل دون متغيرات أو خدمات Manus وتوثيق أي اعتماد خارجي مطلوب.
- [x] تجميع حزمة تسليم كاملة تحتوي المصدر والترحيلات والبيانات التجريبية ووثائق الاستقلال.

- [x] إنشاء وربط حساب Railway باستخدام بريد المالك مع استكمال تحقق المالك عند طلبه.
- [x] إنشاء خدمة Railway وقاعدة MySQL وضبط متغيرات البيئة المحلية.
- [x] نشر الحزمة المستقلة على Railway وتهيئة حساب مالك محلي.
- [x] التحقق من النطاق الجديد وتسجيل الدخول المحلي ونسخة بيانات محمولة خاصة.

- [x] اختيار أقل إعداد Railway مناسب لاستخدام محدود، مع توضيح حد التكلفة ومتى يلزم التوسع.

- [x] استبدال إعداد البريد المرتبط بـGmail بدعم SMTP عام، مع بقاء إعداد Gmail اختياريًا للتوافق.
- [x] إضافة إعداد Railway موثّق لبناء التطبيق من Dockerfile الإنتاج وربط MySQL عبر الشبكة الخاصة.
- [x] تدقيق المراجع المتبقية إلى Manus أو OAuth أو Forge وفصل المراجع التشغيلية عن التوثيق التاريخي.
- [x] إعادة تشغيل فحص TypeScript وVitest وبناء وتشغيل مستقلين بلا متغيرات Manus.
- [x] إنشاء حزمة standalone نهائية خالية من الأسرار وnode_modules وسجلات التشغيل وبيانات المستخدمين الفعلية.
- [x] ربط تطبيق Railway بقاعدة MySQL التجريبية وتهيئة متغيرات التشغيل ومالك محلي دون نقل بيانات الإنتاج.
- [x] التحقق من الرابط الجديد وتسجيل الدخول المحلي وإنشاء نسخة بيانات محمولة خاصة لقاعدة Railway.
- [x] تدقيق ونقل بيانات مشروع نمار التشغيلية من القاعدة السابقة إلى Railway بعد موافقة صريحة، ثم مطابقة أعداد السجلات وبيانات لوحة التحكم.
- [x] توثيق ومطابقة مرجع البيانات والمخطط مع النسخة المستقرة 0951bfba قبل نقل نمار، بما يشمل طلبات المواد والرقابة التخطيطية وصلاحيات مسؤول المشتريات.
- [x] منع إرجاع passwordHash في استجابة المستخدم لجلسة الدخول المحلية والتحقق من سلامة التفويض في Railway.
- [x] التحقق بصريًا من ظهور مشروع نمار وواجهتي تقرير الخامات وطلبات المواد بعد نقل البيانات إلى Railway.
- [x] إنشاء أرشيف مصدر مستقل محدث ونسخة بيانات محمولة خاصة بعد النقل، من دون بيانات أعمال أو أسرار داخل أرشيف المصدر.
- [x] توسيع اختيار بطاقة المادة ليعرض قائمة شاملة وقابلة للبحث لخامات البناء ضمن طلب المواد.
- [x] إصلاح تفعيل وربط بطاقة المادة وبند التكلفة بعد اختيار المشروع والمرحلة، مع رسالة واضحة عند غياب بطاقة خامة أو ربط تخطيطي.
- [x] إعادة إظهار كروت الاستلام والصرف للمواد داخل تدفق الخامات والكميات مع الفصل الواضح عن تقرير الأرصدة والسجل.
- [x] ربط عقود التوريد والتوريد والتركيب ببنود التكلفة وكميات العقد والمستخلصات وعمليات استلام المواد دون إثبات تكلفة عند إنشاء العقد فقط.
- [x] اختبار واجهات المواد والعقود بصريًا وتكامليًا ثم نشر التحديث إلى Railway.
- [x] منع ظهور بطاقة الخامة ذات الحد الأدنى صفر ضمن تنبيه إعادة الطلب، حتى لا تصبح مؤشرات التقرير مضللة عند تهيئة الدليل الأساسي.
- [x] إظهار شعار الشركة المرفوع في رؤوس معاينة وتنزيل جميع المستندات المهنية مع بديل واضح عند عدم توفر الشعار.
- [x] التحقق من صيغة الرابط المتاحة في Railway وتطبيق رابط ملائم أو توثيق متطلبات النطاق المخصص بوضوح.
- [ ] إعداد دخول أول آمن لمصطفى بحساب بريده المعروف وكلمة مرور مؤقتة خاصة تُلزم بتغييرها عند أول تسجيل دخول، من دون إرسال السر في المحادثة.
- [x] اختبار قوالب المستندات ومسار تغيير كلمة المرور ثم نشر التحديث إلى Railway.
- [x] إزالة جميع عناوين وروابط التقارير والإعدادات المحاسبية من واجهة مسؤول المشتريات، مع منع فتحها مباشرة.
- [x] قصر مسؤول المشتريات على تقرير الخامات وطلبات المواد والاستلام والصرف وطلباته الشخصية فقط.
- [x] جعل المشروع إلزاميًا في طلب المواد والاستلام والصرف لمسؤول المشتريات، وحصر الخيارات في المشاريع المسندة إليه.
- [x] اختبار حساب مسؤول المشتريات وتجربة مشروع واحد وعدة مشاريع ثم نشر التعديل إلى Railway.
- [x] إضافة كشف حساب سلف تفصيلي لكل موظف ضمن صفحة الموظفين، يعرض أصل السلفة والخصومات والرصيد المتبقي.
- [x] إضافة شريط بحث وفلترة متقدم لكشوف السلف بالموظف والحالة والفترة ونمط الخصم.
- [x] تمكين تحديد خصم السلفة كاملة من مسير محدد أو جدولتها على عدة أشهر عند إنشاء أو اعتماد السلفة.
- [x] إظهار رصيد السلف واقتراح القسط داخل المسير، مع خيار خصم السلفة أو تأجيلها لكل موظف.
- [x] اختبار دورة السلفة والخصم والتأجيل والنشر إلى Railway.

- [x] منع أو إعادة جدولة رصيد القسط عند الخصم الجزئي حتى لا يختفي من الاستحقاقات المقبلة.
- [x] تحرير حجز أقساط السلف عند حذف مسودة مسير غير مرسلة، ومنع حذف مسير محال للاعتماد أو معتمد.
- [x] إنشاء قيد تسوية يثبت إجمالي الراتب ويقفل جزء سلف الموظفين عند اعتماد الخصم داخل المسير.
- [x] حماية السلف المعتمدة القديمة بلا أقساط مجدولة وإظهارها كرصيد يحتاج جدولة بدل إخفائها.

- [x] إظهار بطاقة إجمالي سند الصرف بعد الضريبة أثناء إدخال القيمة ونسبة الضريبة.
- [x] إضافة إنشاء بطاقة خامة من طلب المواد مع خامة رئيسية وبند تكلفة افتراضي.
- [x] إضافة إنشاء بند تكلفة من طلب المواد وربطه بالحساب الرئيسي في شجرة الحسابات.
- [x] إنشاء سجل مستقل للوثائق والرخص وعقود العمل وإقامات الموظفين مع فلاتر وتواريخ انتهاء.
- [x] ربط فحص يومي تلقائي في Railway لتنبيهات الوثائق الحقيقية بالبريد وإشعار النظام ومنع التكرار.
- [x] وضع سجل الوثائق والرخص قبل صفحة طلباتي في قائمة التنقل.
- [x] إنشاء صفحة مستقلة باسم سلف الموظفين أسفل صفحة الموظفين لتسجيل السلف وكشوف الحساب والبحث والفلترة المتقدمة.
- [x] إضافة بحث متقدم لمسيرات الرواتب المحفوظة بالشهر والسنة والحالة والموظف والمشروع.
- [x] تطبيق ترحيلي 0083 و0084 والتحقق البصري ونشر حزمة التحسينات إلى Railway.

- [x] إظهار نموذج إنشاء سلفة كامل داخل صفحة سلف الموظفين بالمبلغ وطريقة السداد وبداية الخصم وعدد الأقساط.
- [x] إضافة البحث عن سلفة الموظف الأجير برقم الإقامة مع إظهار بيانات المطابقة بوضوح.
- [x] اختبار الحفظ والبحث برقم الإقامة والتحقق من الواجهة ثم حفظ النسخة.

- [x] إضافة نموذج أجير في دليل الموظفين يتضمن الاسم ورقم الإقامة وبيانات الأجر والمشروع والحالة.
- [x] إتاحة اختيار الأجير في مسير الرواتب وصفحة سلف الموظفين مع الحفاظ على التفريق بين الموظف والأجير.
- [x] إضافة اختبارات حفظ الأجير وظهوره في الرواتب والسلف ثم التحقق والنشر.

- [x] مطابقة بنود موازنة نمار وقيمها مع بطاقات التكلفة والحسابات الموجودة.
- [x] إنشاء بطاقات أو حسابات للبنود الناقصة مع الحفاظ على التفريق بين الموازنة والحركة الفعلية.
- [x] تسجيل موازنة نمار المخططة وربطها بتقارير المشروع والداش بورد.
- [x] مراجعة مجموع التكاليف والربح والهامش واختبار عدم اختلال الإجماليات قبل النشر.

- [x] ربط بنود موازنة نمار ببنود التكلفة والحسابات المحاسبية مع فصل المخطط عن الفعلي
- [x] ربط سندات الصرف والفواتير وعقود التوريد والمقاولات والمستخلصات وبطاقات الاستلام والصرف ومستخلصات البيع على الخارطة ببند التكلفة والمشروع والمرحلة
- [ ] إضافة تحقق يمنع حفظ مستند مالي دون سلسلة الربط اللازمة عندما يكون المستند مرتبطًا بمشروع أو بند تكلفة
- [x] إدخال موازنة نمار الفعلية وإنشاء بطاقات البنود غير الموجودة دون إنشاء حركات فعلية
- [x] إظهار المخطط مقابل الفعلي في تقرير المشروع والداش بورد وقائمة الدخل
- [x] كتابة/تحديث اختبارات الربط والموازنة وتشغيل TypeScript والاختبارات والبناء
- [ ] مراجعة واجهات المستندات بصريًا ثم حفظ النسخة المنشورة

- [x] إصلاح الداش بورد: إظهار بطاقة الموازنة الشاملة لنمار بدل الاكتفاء بتقرير المرحلة القديم.
- [x] إضافة مؤشرات الإيراد والتكلفة والزكاة والربح المخطط، والفعلي، والمدفوع، والمستحق، والانحراف في الداش بورد.
- [x] إضافة جدول بنود الموازنة الشاملة للمشروع المحدد مع تمييز المخطط عن الفعلي.
- [x] اختبار الداش بورد بصريًا وبيانيًا ثم حفظ ونشر النسخة المصححة.

- [x] إبقاء إنشاء الفواتير وسندات الصرف والاستلام والمستخلصات والمبيعات إدخالات فعلية بيد المستخدم دون توليد حركات اختبارية.
- [x] إصلاح الداش بورد لعرض الموازنة المخططة المستقلة بوضوح مع الاعتماد على الإدخالات الفعلية التي ينشئها المستخدم لاحقًا.

- [x] إضافة اختيار نوع مستفيد السلفة: موظف شركة أو موظف أجير.
- [x] إظهار قائمة الموظفين لمستفيد الشركة، والبحث برقم الإقامة لمستفيد الأجير.
- [x] حفظ نوع المستفيد ومعرّفه في السلفة وعرضه في كشف الحساب ومسير الرواتب.
- [x] اختبار السلفة لموظف شركة ولأجير ثم نشر النسخة.
- [x] إظهار طلب شراء مواد لموظف الموقع ضمن واجهته التشغيلية وصلاحياته المسموح بها فقط.
- [x] التحقق من أن طلب موظف الموقع يمر بدورة الاعتماد ولا يمنحه صلاحية التقارير أو إدخال التكلفة الفعلية.
- [x] التحقيق في عدم ظهور تعديلات السلف وطلب المواد في الحساب الفعلي رغم النشر.
- [x] التحقق من النسخة المنشورة والمسارات والصلاحية بالحساب الفعلي قبل إعلان اكتمال التعديل.
- [ ] ضمان تطبيق ترحيلات قاعدة البيانات الجديدة عند بدء خدمة Railway قبل تشغيل التطبيق.
- [x] تشخيص سبب اتصال خدمة Railway بقاعدة بيانات لا تحتوي مشروع نمار والبيانات التشغيلية السابقة.
- [x] استعادة بيانات مشروع نمار وموازنته وسجلاته التشغيلية إلى قاعدة Railway الصحيحة دون إنشاء بيانات تجريبية أو التكرار.
- [x] التحقق من ظهور مشروع نمار وموازنته في الداش بورد الحي بعد النقل.

## مخطط تتبع الموافقات والتنبيهات

- [x] إضافة مخطط مرحلي في صفحة الموافقات يوضح المستند والمسؤول الحالي والمراحل التالية.
- [x] إظهار حالة كل مرحلة بوضوح: مكتملة، جارية، بانتظار القرار، أو مرفوضة/مرتجعة.
- [x] إضافة زر بريد تذكير حقيقي أسفل كل مرحلة لمسؤولها مع منع الإشعارات الوهمية.
- [x] تغطية مخطط التتبع ومسار التنبيه باختبارات ثم التحقق بصريًا ونشر النسخة.

## أنواع نشاط الشركات والمشاريع

- [x] إضافة اختيار نوع نشاط الشركة عند الإنشاء: مطور عقاري أو شركة مقاولات.
- [x] إضافة اختيار نوع نشاط المشروع عند الإنشاء: تطوير عقاري أو مقاولات، مع الحفاظ على المشاريع الحالية.
- [x] تكييف نماذج المقاولات لتشمل مستخلصات ودفعات المالك بدل نماذج البيع على الخارطة.
- [x] إضافة اختبارات وفحص الواجهات ثم نشر التعديل بعد التحقق.

## قسم المقايسات التفصيلية

- [x] إنشاء قسم مستقل للمقايسات مع رأس المقايسة وحالتها وإصداراتها وربط مشروع اختياري.
- [x] إضافة بنود تفصيلية تشمل التصنيف والوصف والوحدة والكمية وسعر الوحدة والتكلفة والإجمالي والملاحظات.
- [x] إضافة معاينة وتنزيل/طباعة وحذف إداري للمقايسات دون إنشاء حركات مالية فعلية تلقائيًا.
- [x] إضافة نموذج تعديل تفصيلي للمقايسات المحفوظة.
- [x] تجهيز الربط الاختياري بالمشروع وبند التكلفة، مع إبقاء المقايسة مستقلة عند عدم الربط.
- [x] تجهيز الربط الاختياري بالعقد والمستخلصات عبر قوائم مرتبطة بالمشروع.
- [x] إضافة اختبارات وفحص الواجهة ثم نشر النسخة بعد التحقق.

## إظهار قسم المقايسات

- [x] التحقق من ظهور رابط المقايسات في القائمة الجانبية حسب الدور والشركة.
- [x] التأكد من الوصول المباشر إلى صفحة المقايسات ومعالجة أي حراسة صلاحيات تخفيها خطأً.
- [x] التحقق من النسخة المنشورة بعد إصلاح الظهور.

## مراجعة حالة الطلبات السابقة

- [ ] إعداد جرد موثق للطلبات السابقة وتصنيف كل بند إلى منفذ ومتحقق، منفذ جزئيًا، أو غير منفذ.
- [ ] مراجعة ظهور البنود في القائمة والصلاحيات والنسخة المنشورة بدل الاكتفاء بوجود الكود.
- [ ] تحديد البنود الحرجة التي تحتاج إصلاحًا وإبلاغ المستخدم بما تبقى بوضوح.

## إصلاح قائمة الموظفين في السلف

- [x] تحديد سبب عدم ظهور موظف الشركة أو الأجير في نموذج تسجيل السلفة.
- [x] إصلاح مصدر القائمة أو الفلترة مع الحفاظ على اختيار النوع والبحث برقم إقامة الأجير.
- [x] اختبار الظهور دون إنشاء بيانات اختبارية ثم نشر الإصلاح.

## مراجعة وتنفيذ متطلبات السلف

- [x] مراجعة متطلبات سلف موظفي الشركة والأجراء وكشف الحساب والبحث المتقدم.
- [x] إصلاح ظهور الموظف والأجير فعليًا في نموذج التسجيل مع البحث برقم الإقامة.
- [x] التحقق من خيارات الخصم الكامل أو التقسيط وربطها بالمسير دون إنشاء بيانات اختبارية.
- [x] اختبار الواجهة والحفظ والنسخة المنشورة قبل إعلان الاكتمال.

## قائمة السلفة الفارغة في النسخة المستخدمة

- [x] معالجة الحالة التي تظهر فيها قائمة موظف الشركة كخيار فارغ رغم وجود سجلات فعلية.
- [x] إظهار حالة التحميل والخطأ وعدد السجلات بدل عرض قائمة فارغة بصمت.
- [x] اختبار القائمة من النسخة المنشورة بعد اكتمال تحميل الجلسة والبيانات.

## اختيار المستفيد داخل إنشاء السلفة

- [x] إضافة اختيار موظف الشركة أو الأجير داخل نموذج إنشاء سلفة جديدة، مستقلًا عن فلتر كشف الحساب.
- [x] ربط اختيار المستفيد ببيانات الحفظ وتفعيل زر إرسال السلفة بعد اكتمال الاختيار.
- [x] التحقق بصريًا من الموظف والأجير والزر في النسخة المنشورة دون إنشاء سلفة اختبارية.
- [x] Re-authorize GitHub CLI with full private-repository write access and verify Railway push path
## ميزانية الحسابات الأب والمراحل

- [x] تعريف «المباني والإنشاءات» كحساب أب لموازنات مراحل المشروع.
- [x] ربط كل مرحلة بحساب أب مع احتساب المخطط والمتبقي والانحراف هرميًا دون ازدواج.
- [x] عرض إجمالي الحساب الأب وتفصيل مراحله في الداشبورد والتقارير.
- [x] اختبار مثال مرحلة الحفر مقابل ميزانية المباني والإنشاءات دون إنشاء حركة إنتاجية.
## ربط الحركات بالموازنة وتنظيم الموارد البشرية

- [x] ربط سندات الصرف والفواتير بالمشروع والمرحلة وبند التكلفة لمقارنة المخطط بالفعلي عند تحديد المشروع.
- [x] ربط سند صرف الرواتب بمصروفات الرواتب الفعلية للمشروع ومقارنتها بالموازنة المخططة.
- [x] إظهار «المباني والإنشاءات» كمرحلة رئيسية وإنشاء المراحل الجديدة كفروع منها في صفحة العقود والمراحل.
- [x] منع تكرار تحميل فاتورة المقاول عند إنشاء سند صرف مرتبط بالفاتورة.
- [x] إضافة عنوان رئيسي «الموظفون» وتجميع الموظفين والسلف والحضور والصفحات التابعة تحته في الشريط الجانبي.
- [x] تجهيز الحضور والانصراف لتكاملات البصمة عبر استيراد/واجهة موحدة دون ربط جهاز محدد.
- [x] إضافة تسجيل حضور اختياري من موقع الموظف مع الإحداثيات والدقة والوقت وسياسة موافقة واضحة.
## مواقع العمل المعتمدة للحضور

- [x] إضافة إعداد موقع عمل معتمد مرتبط بالمشروع مع الاسم وخط العرض وخط الطول ونصف قطر السماح.
- [x] ربط تسجيل الحضور الجغرافي بالموقع المعتمد وحفظ نتيجة المطابقة والمسافة والدقة.
- [x] إظهار إعداد الموقع ونطاق السماح في واجهة المشروع/الحضور، مع عدم إنشاء موقع أو حضور افتراضي.
- [x] تجهيز نموذج الموقع لاستقبال مواقع متعددة وتكاملات البصمة مستقبلًا.
- [x] دعم موقع بصمة المكتب الإداري كموقع حضور مستقل بجانب مواقع المشاريع، مع اختيار نوع الموقع في السجل.
- [x] توحيد احتساب تكلفة مستندات الشراء: الفاتورة تسجل الاستحقاق، وسند السداد المرتبط بها لا يُحمّل تكلفة ثانية؛ مع اختبار وحدة يغطي السداد المباشر.
- [x] التحقق النهائي من TypeScript والاختبارات والبناء بعد ربط الموازنة والتكلفة الفعلية.
- [x] إصلاح تمكين حفظ موقع المكتب الإداري مستقلًا عن اختيار مشروع، مع إبقاء اختيار المشروع إلزاميًا لمواقع المشاريع.
- [x] إصلاح الصفحة البيضاء المؤقتة عند فتح صفحة المعاينة/المشاريع بإضافة شاشة تحميل أولية واضحة أثناء تشغيل التطبيق.
- [x] إعادة تفويض GitHub بصلاحية الكتابة للمستودع الخاص المتصل بـ Railway ثم مزامنة آخر نسخة.

## توسعة واجهة الإدارة الحالية
- [x] إصلاح قائمة اختيار المشروع غير النشطة ومنع تداخل الداشبورد مع الشريط الجانبي.
- [x] فصل مؤشرات مركز التكلفة إلى بطاقات مستقلة للمخطط والفعلي والمدفوع والمستحق والانحراف.
- [x] إضافة أرشفة للمهام المكتملة مع بحث/عرض مبسط وزر حذف محمي بصلاحية المدير.
- [x] تحسين خريطة الموافقات لتعرض المرسل وصفته ونوع الطلب وتاريخه والمسؤول الحالي والمسؤولين القادمين، مع تنبيه بريد للمرحلة الحالية فقط.
- [x] تقييد عرض خريطة الموافقة حسب الصلاحية بحيث تظهر لمسؤول الطلب والجهات المعنية دون كشف غير مصرح به.
- [x] إنشاء قسم غرفة الاجتماعات لإدارة الاجتماعات والأعضاء والتاريخ والحالة والرابط الاختياري والأرشفة والحذف الإداري.
- [x] إعادة تنظيم الشريط الجانبي تحت قسم HR للموظفين والسلف والحضور والصفحات التابعة.
- [x] قصر إنشاء الاجتماعات واختيار فريق العمل على المدير العام، مع عرض التفاصيل لمصطفى والمالك وفق الصلاحية.
- [x] إنشاء قسم التسويق والدعايا لإدارة الموقع التعريفي وملفات الماكيتات والتصميمات وروابط الخرائط وتجهيز الدومين مستقبلًا.
- [x] إضافة اختبارات Vitest وتحقق بصري وبناء إنتاجي لكل نطاق مكتمل قبل النشر.
- [x] استعادة العرض التفصيلي الكامل للداشبورد للمشروع والمرحلة النشطة والموازنة وتقارير السيولة وجميع المؤشرات السابقة، مع تطوير ترتيب العرض دون حذف البيانات.
- [x] إصلاح قائمة اختيار المشروع في الداشبورد ومنع تداخل المحتوى مع الشريط الجانبي على الشاشات الواسعة.
- [x] استعادة العرض التفصيلي الكامل للداشبورد للمشروع والمرحلة النشطة والموازنة وتقارير السيولة وجميع المؤشرات السابقة، مع تطوير ترتيب العرض دون حذف البيانات.
- [x] إصلاح قائمة اختيار المشروع في الداشبورد ومنع تداخل المحتوى مع الشريط الجانبي على الشاشات الواسعة.
- [x] إلزام تاريخ الفاتورة وسند الصرف في الواجهة والخادم وإظهاره في أرشيف المستندات والمعاينة.
- [ ] تفعيل رفع ملفات الماكيتات والتصميمات مباشرة عبر مزود تخزين خارجي بعد ضبط بيانات اعتماده، مع حفظ رابط الملف فقط في قاعدة البيانات.
- [ ] رفع الماكيتات والتصميمات مباشرة من داخل النظام عبر مزود تخزين دائم — مؤجل بناءً على قرار المستخدم، ولا يعطل قسم التسويق الحالي.
- [ ] إضافة منشئ موقع تعريفي منشور من داخل قسم التسويق والدعايا، مع صفحات ومحتوى قابلين للتحرير.
- [ ] ربط التسجيل الفعلي في Google Business Profile أو خرائط Google بعد إعداد بيانات التكامل الخارجية.
- [ ] إضافة مزود فيديو مباشر اختياري لغرفة الاجتماعات بدل الاكتفاء برابط Zoom أو Google Meet.
- [x] مطابقة نسخة Railway الحية مع آخر commit محفوظ، والتأكد من ظهور التعديلات فعليًا قبل اعتمادها كمكتملة.
- [x] إضافة عدادات زمنية واضحة للمراحل في الداشبورد: بداية المرحلة، المنقضي، المتبقي، نسبة الوقت، وحالة التأخير.
- [x] مطابقة ترتيب الداشبورد مع التخطيط المرجعي: عدادات الوقت أولًا، ثم مقارنة المشروع والمرحلة، ثم ملخص السيولة، ثم تفصيل مراحل البناء، مع إبقاء المؤشرات الجديدة داخل هذا التسلسل.

- [ ] إصلاح اختلاف التخطيط الظاهر في النسخة الحية عن الداشبورد المحفوظ والتحقق من ظهور الترتيب المرجعي فعليًا.
- [ ] إصلاح زر اختيار المشروع في الداشبورد وجعله يفتح القائمة ويبدّل المشروع مع تحديث البيانات.

- [ ] إعادة هيكلة الداشبورد بالكامل كلوحة قيادة تنفيذية احترافية متعددة المستويات مع الحفاظ على البيانات الحالية.
- [ ] إضافة تسلسل بصري واضح: تعريف المشروع والمرحلة، مؤشرات الصحة، الأداء المالي والسيولة، التقدم الزمني، ثم تفاصيل المراحل والتنبيهات.
- [x] إصلاح اختيار المشروع والمرحلة والتأكد من تحديث جميع البطاقات والتقارير عند التغيير.
- [x] اختبار الداشبورد بصريًا ووظيفيًا ثم حفظ ونشر النسخة المستقرة.

- [x] تطوير الداشبورد اعتمادًا على الصور المرجعية مع تحسين بصري وتنفيذي إضافي.
- [x] نقل اختيار الشركة إلى شريط علوي واضح وتثبيته دون تداخل مع المحتوى.
- [x] إصلاح اختيار المشروع من أعلى الداشبورد وإظهار حالة الاختيار وتحديث البيانات المرتبطة به.

- [x] استعادة تخطيط الداشبورد القديم فقط دون التراجع عن تحديثات الموافقات والمحاسبة والموازنة وHR والاجتماعات والتسويق.
- [x] الحفاظ على اختيار الشركة والمشروع وإصلاح تفاعلهما داخل التخطيط القديم.
- [x] اختبار أن الوحدات الأخرى لم تتأثر بعد استعادة الداشبورد.

- [x] حذف قسم الموقع والمواد الدعائية من القائمة الجانبية والروابط الظاهرة.
- [x] إزالة المسار غير المطلوب من التوجيه دون المساس بباقي أقسام النظام.

- [x] التحقق وظيفيًا من أن اختيار المشروع من الداشبورد يبدّل المشروع ويحدّث بياناته الفعلية في جميع المؤشرات والتفاصيل.

- [x] استكمال استعادة شكل الداشبورد القديم مع بقاء البيانات والتحديثات الحديثة.
- [x] حذف قسم الموقع والمواد الدعائية من التنقل والتوجيه.
- [x] اختبار اختيار المشروع وتحديث المؤشرات قبل اعتماد النسخة النهائية.

- [x] العثور على نسخة الداشبورد المطابقة للصور المرجعية، لا النسخة القريبة منها، وإعادة تطبيقها مع الحفاظ على باقي التحديثات.
- [x] التحقق من أن النسخة الظاهرة في المعاينة هي التخطيط المطابق للصور فعلًا.

- [x] إزالة الملخص المالي العام من أعلى الداشبورد وإظهار لوحة المشروع القديمة التي تحتوي على العدادات والمقارنات والسيولة وتفاصيل المراحل.
- [x] اختبار أن اختيار المشروع يبدّل لوحة المشروع والبيانات المعروضة بدل إبقاء الملخص العام ثابتًا.

- [x] تشخيص استمرار ظهور الملخص المالي العام في الرابط الذي يفتحه المستخدم رغم تعديلات Home.tsx المحفوظة.
- [x] التحقق من أن الخدمة المنشورة تعرض build/commit الحالي وإبطال أي مسار أو cache يعيد الواجهة القديمة.

- [x] مزامنة نسخة الداشبورد المصححة إلى مستودع GitHub المرتبط بـRailway والتحقق من Deployment الجديد.

- [x] بناء داشبورد تنفيذي عربي RTL جديد بمظهر احترافي واضح فوق البيانات الحالية.
- [x] عرض الشركة والمشروع والمرحلة والصحة المالية والزمنية والسيولة وتفاصيل المراحل في تسلسل تنفيذي مفهوم.
- [x] ربط المرشحات بتحديث البيانات واختبار العرض على سطح المكتب والموبايل ثم نشره على Railway.

- [x] إصلاح تداخل القائمة الجانبية مع محتوى الداشبورد على سطح المكتب والشاشات الضيقة.
- [x] إظهار المرحلة الحالية الفعلية وميزانيتها وتكلفتها وتقدمها وتواريخها في الداشبورد عند وجودها.

- [x] تشخيص سبب ظهور «لا توجد مرحلة نشطة» لمشروع نمار رغم وجود مراحل، والتحقق من ربط معرف المشروع بالمراحل.
- [x] إصلاح عرض اسم المرحلة الحالية وميزانيتها وتكلفتها ورصيدها وتقدمها في الداشبورد.

- [x] إصلاح اختفاء مرحلة الحفر من صفحة المشاريع والمراحل رغم وجودها وربطها بمشروع نمار في قاعدة البيانات.
- [x] توحيد عرض المرحلة في صفحة المشاريع والمراحل مع activeStage في الداشبورد.

- [x] التحقق من وجود المستخلص والفاتورة المرتبطين بمرحلة الحفر في مشروع نمار وإظهار بياناتهما عند مراجعة المرحلة.
- [x] الحفاظ على ربط المستخلص والفاتورة بالمرحلة وبند التكلفة والمشروع أثناء إصلاح العرض.

- [x] إصلاح تداخل القائمة الجانبية مع محتوى الداشبورد بشكل ثابت على سطح المكتب والمقاسات الضيقة.
- [x] التحقق من الربط الكامل لمرحلة الحفر في نمار مع المشروع وبند التكلفة والعقد والمستخلص والفاتورة والتقارير.
- [x] التأكد من ظهور المرحلة والمستندات والقيم نفسها في صفحة المشاريع والداشبورد دون تكرار أو أصفار غير مبررة.

- [ ] إصلاح نهائي بعد التحقق الحي: لا تظهر مرحلة الحفر في بطاقة المرحلة الحالية رغم وجودها في قاعدة البيانات.
- [x] التحقق بصريًا من عدم تداخل القائمة الجانبية مع محتوى الداشبورد في النسخة المنشورة.

- [ ] معالجة اختفاء مرحلة الحفر من واجهة المشاريع والمراحل مع منع إنشاء سجل بديل أو مكرر.

- [ ] التحقق النهائي بمقاس سطح المكتب من أن القائمة الجانبية منفصلة بالكامل عن محتوى الداشبورد وبطاقات وصفحة المشاريع، وعدم التسليم إذا وُجد تداخل أو قص.
