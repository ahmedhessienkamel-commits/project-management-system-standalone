...
- [ ] إضافة قسم مستقل للعملاء داخل حركة المستندات
- [ ] إضافة قسم مستقل للموردين داخل حركة المستندات
- [ ] عرض البيانات القانونية والعنوانية والتواصلية للطرف في السجل
- [ ] إتاحة تعديل العميل أو المورد من السجل حسب الصلاحية
- [ ] إتاحة حذف أو تعطيل العميل أو المورد مع حماية المستندات والقيود المرتبطة
