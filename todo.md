...
- [ ] إكمال سلسلة اعتماد المخزون: مسؤول الموقع ثم مصطفى ثم المالك
- [ ] إصلاح أزرار إنشاء المورد/العميل داخل نماذج المستندات
- [ ] إعادة بناء قوالب تسجيل وعرض فواتير البيع والشراء والسندات
- [ ] إضافة حقول ZATCA الأساسية ورمز QR للفواتير النهائية
- [ ] إضافة اختبارات وحدات للأدوار وسلسلة الاعتماد
