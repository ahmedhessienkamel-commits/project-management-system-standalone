...
- [ ] تصفير الضريبة تلقائيًا عند اختيار رواتب مشروع
- [ ] إظهار اختيار موظف شركة أو أجير عند اختيار رواتب مشروع
- [ ] عرض قائمة الموظفين لموظف الشركة وحقل اسم يدوي للأجير
- [ ] التحقق من الحقول وحفظ البيانات والاختبار والمعاينة وحفظ الإصدار

## Purchase invoice settlement and accounting submenu
- [ ] إضافة سداد كامل أو جزئي لفاتورة الشراء
- [ ] اختيار البنك أو الخزينة عند تسجيل السداد
- [ ] حساب المدفوع والمتبقي ومنع تجاوز قيمة الفاتورة
- [ ] وضع الأصول الثابتة وشجرة الحسابات تحت قائمة محاسبة فرعية مستقلة
- [ ] إضافة اختبار ومعاينة وبناء وحفظ الإصدار
