...
- [ ] فحص المصروفات التي بلا بند تكلفة أو بلا تحميل متسق
- [ ] فحص المراحل غير المتطابقة مع مشروع الحركة
- [ ] فحص المستخلصات والمبيعات ذات الإجمالي غير المتسق
- [ ] توجيه تنبيهات الجودة إلى شاشة الإجراء المناسبة
- [ ] إضافة اختبار لفحوص الجودة المالية
...
- [ ] إضافة زر إنشاء مرحلة بجوار قائمة المرحلة في نموذج المستخلص
...
- [ ] إضافة اختبارات وبناء ومعاينة وحفظ الإصدار
...
- [ ] إكمال تعديل بيانات المستخلصات والموردين والعملاء من سجلاتهم
- [ ] استكمال ربط مصفوفة الصلاحيات بمسارات الموافقة والتنفيذ
- [ ] فصل صفحات التسجيل عن صفحات الكشوف والتقارير بدون تكرار
...
- [ ] إضافة اختبارات شاملة للروابط والصلاحيات وسلامة الحركات المالية
