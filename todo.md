...
- [ ] استكمال المراجعة والتعديل والمعاينة والتنزيل للمقايسات دون إنشاء حركات مالية فعلية تلقائيًا.
- [x] تجهيز الربط الاختياري بالمشروع وبند التكلفة، مع إبقاء المقايسة مستقلة عند عدم الربط.
- [ ] استكمال الربط التفصيلي الاختياري بالعقد والمستخلصات بعد اعتماد واجهاتها.
