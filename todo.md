...
- [ ] إضافة قائمة افتراضية من نحو 15 بطاقة تكلفة، تشمل بطاقة عدد بناء للعدد البسيطة


## Editable account and cost trees
- [ ] إضافة تعديل وتعطيل للحسابات مع منع حذف الحسابات المستخدمة في قيود
- [ ] إضافة تعديل وتعطيل لبطاقات بنود التكلفة
- [ ] إضافة حسابات فرعية وبطاقات تكلفة فرعية من واجهة الشجرة
- [ ] إضافة أزرار واضحة للإضافة والتعديل والتعطيل داخل شجرة الحسابات وبطاقات التكلفة
- [ ] اختبار حماية السجلات المستخدمة في التقارير والقيود

- [ ] دعم إضافة أكثر من حساب بنكي وأكثر من حساب مصروفات تحت الحساب الأب المناسب


## Accounting report date range
- [ ] إضافة تاريخ من وتاريخ إلى كمدخلين موحدين لجميع التقارير المحاسبية
- [ ] تمرير نطاق التاريخ إلى ميزان المراجعة وقائمة الدخل والميزانية والمركز المالي وتقرير بنود التكلفة
- [ ] اختبار اختلاف نتائج التقارير عند تغيير الفترة


## Group payroll sheet request
- [ ] إضافة مسير شهري جماعي يعرض جميع الموظفين في جدول واحد
- [ ] اختيار الشهر والسنة مرة واحدة للمسير
- [ ] إضافة أعمدة الحضور والغياب والخصم والراتب المستحق والمدفوع والمتبقي
- [ ] دعم تصنيف الراتب والمشروع أو المصروف الإداري داخل كل صف
- [ ] حفظ عدة صفوف رواتب دفعة واحدة مع الحفاظ على الموافقات والتقارير
- [ ] طباعة وتصدير مسير الرواتب الجماعي
