...
- [ ] إضافة مراقبة المخزون والكميات إلى الأقسام المسموحة للمدير العام كتقرير قراءة فقط.
- [ ] إخفاء أزرار إضافة واستلام وصرف وتعديل وحذف المخزون عن المدير العام.
- [ ] عرض أرصدة الأصناف وحركات الاستلام والصرف والكميات المتبقية والمشروع والمورد كتقرير شامل.
- [ ] اختبار القراءة فقط والفحص البصري وحفظ النسخة المنشورة.
