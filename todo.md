...
- [ ] مراجعة قيد فاتورة المشتريات ليكون مدينًا على بند التكلفة أو الخامات فقط
- [ ] مراجعة قيد فاتورة المبيعات ليكون دائنًا على إيراد المشروع فقط
- [x] منع خلط بنود التكلفة داخل فاتورة المبيعات
- [ ] فصل السداد والتحصيل عن إنشاء الفاتورة مع تحديث المتبقي والحالة
- [ ] إلزام اختيار المورد في المشتريات والعميل في المبيعات مع إبقاء الرقم الضريبي اختياريًا
- [ ] إتاحة ربط فاتورة المشتريات بمستخلص اختياري
- [ ] تثبيت حالات المسودة وعرض السعر والنهائي مع نماذج عرض وتسجيل واضحة
