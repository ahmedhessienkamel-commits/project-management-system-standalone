...
- [ ] فصل رابط البنوك والخزائن عن صفحة معلومات الشركة
- [ ] قصر الصفحة المستقلة على البنوك والخزائن وإدارة الحسابات
- [ ] إضافة كشف حساب لأي بنك أو خزينة مع فلاتر التاريخ
- [ ] ربط كشف الحساب بالقيود المحاسبية الفعلية
- [ ] إضافة اختبار وبناء ومعاينة للصفحة المستقلة
