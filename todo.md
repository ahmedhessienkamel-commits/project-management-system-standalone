...
- [x] تنظيم القائمة الجانبية تحت قسم HR يضم الموظفين والسلف والرواتب والحضور والإجازات والعهد ذات الصلة دون تغيير الروابط أو الصلاحيات.

- [x] تثبيت النسخة المسترجعة e7b04caf كمرجع رئيسي قبل الإضافات ووضع علامة Git دائمة لها.

- [ ] نشر نسخة d48f7d37 السابقة للإضافات على Railway دون أي تعديلات أو بيانات جديدة.
