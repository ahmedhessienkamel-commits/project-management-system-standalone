...
- [ ] إعادة ترتيب صفحة الخامات والكميات بفصل لوحة الأرصدة والتقارير عن بطاقات الإدخال والحركات والخدمات.
- [x] ربط طلب المواد باختيار بطاقة خامة فعلية لتحديد نوع المادة تلقائيًا بدل إدخال وصف حر فقط.
- [x] ربط طلب المادة بالمشروع والمرحلة وبند التكلفة، وإظهار مرجع التحميل التشغيلي والمخطط.
- [x] إضافة فحص توافق كمية طلب المادة مع الكمية المخططة والمتعاقد عليها والكمية المطلوبة أو المستلمة سابقًا.
- [ ] حفظ مراجع بطاقة الخامة وبند التكلفة داخل طلب المادة وعرضها في السجل والموافقة والتصدير.
- [x] إضافة اختبارات للرقابة التخطيطية وربط طلبات المواد بالبطاقات والتكاليف.

- [x] إعادة التحقق المرحلي من صلاحيات مسؤول المشتريات والتنقل المخصص له بعد الاستعادة.
- [x] إعادة اختبار نموذج طلب المواد المرتبط بالخامـة والمرحلة وبند التكلفة على نسخة مستقرة.
- [x] التحقق من تحميل الواجهة والاختبارات بعد كل مرحلة قبل أي تغيير لاحق في صفحة الكميات.
