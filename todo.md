...
- [ ] إضافة خيار حفظ الفاتورة كمسودة أو إصدارها كسند نهائي
- [ ] منع المسودات من الترحيل للتقارير النهائية حتى اعتمادها
- [ ] اختبار الطباعة والتصدير والحالات والصلاحيات وحفظ الإصدار
