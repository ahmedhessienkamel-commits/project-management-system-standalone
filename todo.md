...
- [ ] التحقق من رابط النسخة التي يستخدمها العميل ومزامنتها مع التعديلات المنشورة قبل اعتبار أي بند منجزًا.
- [ ] التحقق من ظهور بطاقات السلف والإجازات والعهدة وكشف المورد في البيئة الفعلية بحساب العميل، لا في بيئة التطوير فقط.

- [ ] استبدال منطقة Railway غير الصالحة `ams` بمنطقة تشغيل متاحة لخدمة ERP الإنتاجية.
- [ ] مزامنة الإصلاحات الأخيرة مع فرع GitHub المرتبط بخدمة Railway والتحقق من نشرها بنجاح.
