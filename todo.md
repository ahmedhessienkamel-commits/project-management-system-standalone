...
- [x] إزالة حزمة تنظيم HR التي تضمنت ملفات ترحيل غير مقصودة والعودة إلى النسخة المرجعية المستقرة دون تغيير البيانات.
- [ ] إعادة تنفيذ تنظيم القائمة الجانبية تحت قسم HR من نسخة نظيفة، بعد فصل ملفات الترحيل غير المقصودة عن تغيير التنقل.
