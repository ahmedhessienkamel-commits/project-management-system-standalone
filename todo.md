...
- [ ] إتاحة نوع تحميل مشروع أو إداري وعمومي أو نثريات عامة
- [ ] جعل اختيار المشروع غير إلزامي للمصروف الإداري والنثريات
- [ ] جعل المرحلة اختيارية داخل نموذج المصروف
- [ ] إضافة زر إضافة بند تكلفة من نموذج المصروف
- [ ] اختيار البند الجديد تلقائيًا بعد حفظه
- [ ] اختبار انعكاس التحميل الصحيح في التقارير والحسابات


## Custody allocation and all filter
- [ ] جعل مشروع حركة العهد اختياريًا
- [ ] تحديد نوع التحميل من الحركة أو الفلتر دون إلزام المشروع
- [ ] إضافة خيار الكل لعرض جميع حركات الموظف
- [ ] دعم فلاتر المشروع والإداري والنثريات والتحميل العام
- [ ] تحديث الرصيد التراكمي والتصدير وفق الفلتر المحدد
...
- [ ] جعل رابط كشوف حسابات العهد يفتح تبويب كشف الحساب مباشرة
- [ ] إضافة خيار الكل في تصفية التحميل
- [ ] إظهار كشف الحساب بعد اختيار الموظف دون اشتراط مشروع
- [ ] فصل شاشة حركة العهد عن شاشة كشف الحساب بوضوح
