...
- [ ] فتح نموذج سند الصرف في بداية صفحة المحاسبة عند اختياره
- [ ] وضع بطاقات المستندات قبل قسم التقارير المحاسبية
- [ ] نقل التقارير المحاسبية إلى قسم مستقل أسفل المستندات
- [ ] التحقق من الروابط والمعاينة وحفظ الإصدار

## Accounting document card placement
- [ ] إظهار نموذج المستند المختار مباشرة تحت كروت المستندات لكل الأنواع
- [ ] إبقاء التقارير المحاسبية أسفل نماذج المستندات في قسم مستقل
- [ ] اختبار سند الصرف والقبض والقيد والفواتير وأوامر الشراء والمعاينة وحفظ الإصدار

## Separate accounting setup menu
- [ ] إنشاء قائمة مستقلة لإعدادات الأصول الثابتة وشجرة الحسابات
- [ ] نقل عرض الأصول الثابتة وشجرة الحسابات إليها مع الحفاظ على التعديل والإضافة
- [ ] اختبار الروابط والمعاينة وحفظ الإصدار

## Payment voucher expense categories
- [ ] إضافة تصنيف خامات ورواتب ومصروف تشغيلي إلى سند الصرف
- [ ] إظهار المشروع وبند التكلفة أو الموظف حسب التصنيف المختار
- [ ] حفظ التصنيف والربط في المستند والقيد والتقارير
- [ ] إضافة اختبار ومعاينة وحفظ الإصدار

## Supplier and purchase invoice linkage
- [ ] فصل تصنيف المورد عن المقاول في سند الصرف
- [ ] إضافة اختيار مورد خامات مستقل عن المقاولين
- [ ] إضافة اختيار فاتورة شراء مرتبطة بالمورد
- [ ] حفظ الربط في السند والتقارير ومنع اختيار فاتورة لمورد آخر
- [ ] إضافة اختبار ومعاينة وحفظ الإصدار
