...
- [ ] إنشاء خدمة Railway وقاعدة MySQL وضبط متغيرات البيئة المحلية.
- [ ] نشر الحزمة المستقلة على Railway وتهيئة حساب مالك محلي.
- [ ] التحقق من النطاق الجديد وتسجيل الدخول المحلي والنسخ الاحتياطي.
...
- [ ] ربط تطبيق Railway بقاعدة MySQL التجريبية وتهيئة متغيرات التشغيل ومالك محلي دون نقل بيانات الإنتاج.
- [ ] التحقق من الرابط الجديد وتسجيل الدخول المحلي وإنشاء نسخة احتياطية أولية لقاعدة Railway.

- [ ] تدقيق ونقل بيانات مشروع نمار التشغيلية من القاعدة السابقة إلى Railway بعد موافقة صريحة، ثم مطابقة أعداد السجلات وبيانات لوحة التحكم.
