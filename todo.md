...
- [ ] إضافة قائمة المستند المرتبط ومرتجع الفاتورة مع حماية القيود

## Credit note and sales return
- [ ] إضافة نوع إشعار دائن مرتبط بالفاتورة الأصلية
- [ ] إضافة اختيار مرتجع كامل أو جزئي مع منع تجاوز قيمة الفاتورة
- [ ] تحديث المتبقي والتحصيلات دون حذف أو تعديل الفاتورة الأصلية
- [ ] إظهار مرجع الفاتورة الأصلية في الإشعار وسجل المستندات
- [ ] إتاحة اختيار عرض سعر أو عقد أو مستخلص كمستند مرتبط بفاتورة المبيعات
- [ ] حفظ نوع ورقم المرجع المرتبط وإظهاره في المعاينة وPDF والسجل
...
- [ ] إضافة منع الترحيل المكرر ومنع تجاوز الدفعات أو المرتجعات للقيمة الأصلية
