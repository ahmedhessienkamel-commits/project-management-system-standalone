...
- [ ] إضافة نوع سند الصرف: مقاول أو مصروفات إدارية أو مصروفات نثرية
- [ ] إظهار قائمة المقاولين عند اختيار نوع مقاول
- [ ] جعل ربط المشروع اختياريًا في سند الصرف
- [ ] حفظ التصنيف والمقاول والمشروع في الترحيل والتقارير
- [ ] إضافة اختبار ومعاينة وبناء وحفظ الإصدار
