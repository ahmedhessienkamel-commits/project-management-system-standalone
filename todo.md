...
- [ ] إزالة صفوف بطاقات الخامات من تقرير المشاريع والمراحل
- [ ] إبقاء تقرير المشاريع والمراحل لمراحل البناء فقط
- [ ] إضافة أو إبراز تقرير تكلفة الخامات داخل قائمة الدخل فقط
- [ ] اختبار المعاينة والتصدير بعد الفصل
