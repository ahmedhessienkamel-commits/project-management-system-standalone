...
export default function Approvals() {
  ...
  const [requestType, setRequestType] = useState<"all" | "leave" | "advance">("all");
  ...
  const pendingLeaves = canDecideEmployeeRequests ? leaveRequests.filter((request) => request.status === "pending" && matchesRequestFilter(request, "leave")) : [];
  const pendingAdvances = canDecideEmployeeRequests ? advanceRequests.filter((request) => request.status === "pending" && matchesRequestFilter(request, "advance")) : [];
