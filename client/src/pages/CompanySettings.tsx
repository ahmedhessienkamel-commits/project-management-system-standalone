...
export default function CompanySettings() {
  ...
  const [newCompanyForm, setNewCompanyForm] = useState({ legalName: "", tradeName: "", commercialRegistration: "", taxNumber: "", nationalAddress: "", phone: "", email: "", logoUrl: "" });
  ...
  const createCompany = trpc.erp.companies.create.useMutation({ onSuccess: () => { utils.erp.companies.list.invalidate(); setNewCompanyForm({ legalName: "", tradeName: "", commercialRegistration: "", taxNumber: "", nationalAddress: "", phone: "", email: "", logoUrl: "" }); } });
