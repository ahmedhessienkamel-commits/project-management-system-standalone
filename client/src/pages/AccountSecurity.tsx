...
export default function AccountSecurity({ required = false }: { required?: boolean }) {
  ...
  const mutation = trpc.auth.setPassword.useMutation({ onSuccess: async () => { await utils.auth.me.invalidate(); setPassword(""); setConfirm(""); if (required) setLocation("/"); else setMessage("تم إنشاء كلمة المرور بنجاح. يمكنك الآن الدخول بالبريد وكلمة المرور."); } });
