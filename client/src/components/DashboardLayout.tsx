...
function DashboardLayoutContent({
  ...
  const roleLabelAllowList: Record<string, string[] | undefined> = {
    general_manager: ["لوحة التنفيذ", "التقارير", "الموافقات والمستندات", "المهام اليومية"],
  ...
  const visibleQuickActions = allowedLabels ? quickActions.filter((action) => action.path.includes("/operations") || action.path.includes("/inventory") || action.path.includes("/tasks")) : quickActions;
